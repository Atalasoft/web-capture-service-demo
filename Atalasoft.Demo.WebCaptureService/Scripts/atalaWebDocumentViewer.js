...
/**
     * @private
     */},{key:"Platform",get:function(){return this.platform}}]),o}(v),y=new v,Kt=new b,x=y,$t={
...
/**
   ...
   */
Name:3},_={FileUploadRejectReason:w,SelectedItemsOrder:Qe,SelectionMode:Ye,ScrollArea:on,PageSelection:nn,Fitting:tn,ScrollDirection:en,MouseToolCursor:Re,MouseToolType:$t,Browser:x},xe={
/**
   * Image annotation.
   */
image:"image",
...
/**
   ...
   */
valueHeightShort:"short"},cn={annotations:S};
/**
 ...
 * @private
 */
function X(e,t,n){for(t||(t={x:0,y:0}),n||(n=e.target instanceof HTMLElement?e.target:null),Kt.Explorer&&null===e&&(e=event),e instanceof MouseEvent?(t.x=e.clientX,t.y=e.clientY):(t.x=e.touches[0].clientX,t.y=e.touches[0].clientY);n&&!isNaN(n.offsetLeft)&&!isNaN(n.offsetTop);)t.x-=n.offsetLeft-n.scrollLeft,t.y-=n.offsetTop-n.scrollTop,n=n.offsetParent instanceof HTMLElement?n.offsetParent:null;return t}
/**
 * @private
...
/**
   ...
   */
function(){if(Kt.Explorer){var e=parseInt(Kt.Version,10);10<=e&&e<12&&d.node&&d.node.parentNode&&d.node.parentNode.insertBefore(d.node,d.node)}}()}}a.commitTransform=function(){var e,t,n;Qt.extend(u,(e=g,t=r.getZoom(h._pageindex),{x:(n=e.split()).dx/t,y:n.dy/t,width:n.scalex/t,height:n.scaley/t})),d.transform(E()),C(),V=null},a.transformUI=function(e,t,n,o){g=Jt.matrix(n,0,0,o,e,t),V||(V=function(e,t){var n;if(e.points&&1<e.points.length){var o=h.getBox();(n=Jt.matrix(1,0,0,1,0,0)).scale(1/o.width,1/o.height,0,0),n.translate(-o.x,-o.y)}else(n=Jt.matrix(t,0,0,t,0,0)).translate(e.x,e.y),n.scale(e.width,e.height,0,0);return n}(u,1)),g.add(V.a,V.b,V.c,V.d,V.e,V.f),d.transform(g.toTransformString()),s&&s.repaint()};var V=null;function H(e,t,n){return t>=e.x&&t<=e.x+e.width&&n>=e.y&&n<=e.y+e.height}},we=function(e,t){var o=t,i=this,n=new j(i),a=null,r=null,l=null,s=null,c=null,u=null,d=null,h=null,f=e.multiview?e:{
/**
...
/**
     ...
     */
setStamps:Q};if(e.__exposedApi=r.annotations,!t)return null;var s=n._config,c=n._pages,u=!1,d=null,h=null,f=null,p=null,g=null,y={annos:[],activepage:null,activeanno:null,readonly:!!o,zoom:l.getZoom(),getZoom:b.getPageScale,getViewerTransform:b.getViewerTransform,getPageRotation:b.getPageRotation},m={},v=!1,x=!1,_={click:"annotationclicked",dblclick:"annotationdoubleclicked",touchstart:"annotationtouchstart",interactend:"annotationtouchend",touchmove:"annotationtouchmove",pinchmove:"annotationpinchresize",rightclick:"annotationrightclicked",mousedown:"annotationmousedown",mousedownleft:"annotationmousedownleft",mousedownright:"annotationmousedownright",mousemove:"annotationmousemove",mouseout:"annotationmouseout",mouseup:"annotationmouseup",mouseover:"annotationmouseover",annocreate:"annotationcreated",annoload:"annotationloaded",moved:"annotationmoved",rotated:"annotationrotated",annoresized:"annotationresized",repaint:"annotationrepainted",layerinserted:"layerinserted",layerremoved:"layerremoved",layermoved:"layermoved",layerschanged:"layerschanged",annotationchanged:"annotationchanged",annotationtextchanged:"annotationtextchanged"};function w(){u=!0,y.readonly||(h=L(f),p=new Pe(n._config.parent),null!=s.annotations.defaults&&Y(s.annotations.defaults),null!=s.annotations.stamps&&Q(s.annotations.stamps),null!=s.annotations.images&&J(s.annotations.images),null!=s.annotations.custom&&K(s.annotations.custom))}
/**
   * [Internal] Disposes memory intensive objects
   * @returns undefined
   */function z(e){g.translate(e.dx,e.dy)}function P(e){y.zoom=e.zoom}function D(e,t,n){if(e||"number"!=typeof t||(t=T(t)),t=t||[],null==n?n=y.annos.length:n<0&&(n=0),n>y.annos.length){var o=y.annos.length;y.annos[n]=t;for(var i=o;i<y.annos.length;++i)y.annos[i]||(y.annos[i]=[])}else y.annos.splice(n,0,t);return n}function T(e){return e<y.annos.length?y.annos.splice(e,1)[0]:null}function k(e,t){return D(null,T(e),t)}function C(e){e&&e.remove&&!e.grip&&e.paper&&e.paper._trash&&e.paper._trash.push(e)}function E(e){S(e.index,e.page)}function S(e,t){if(e<y.annos.length&&(M(t),y.annos[e]&&y.annos[e].length))for(var n,o=0;o<y.annos[e].length;o++)(n=y.annos[e][o])._pageindex=e,n.repaint(t._paper),n.get("selected")&&a.select(n,e,!0)}function M(e){e._grips.clear(),e._paper._annos.remove(),e._paper._annos.clear(),e._paper.forEach(function(e){e&&e.remove&&!e.grip&&e.paper&&e.paper._trash&&e.paper._trash.push(e)}),e._paper._trash.remove(),e._paper._trash.clear(),ce()}function F(e){y.activepage=e}function A(e){e.page._paper&&(M(e.page),e.page.append(e.page._paper.canvas))}function I(e){O(e.page)}function O(e){if(e&&0<=e._index&&y.annos[e._index]){for(var t=0;t<y.annos[e._index].length;t++)y.annos[e._index][t].repaint();e&&e._grips.repaint()}}function V(e){h&&(h.visible&&H(),h.remove());var t=Qt.extend(!0,{},f);if(l.trigger("contextmenu",[y.activeanno.getClonedData(),t]),Qt.isEmptyObject(t))h=null;else{for(var n in t)t.hasOwnProperty(n)&&(t[n]=B(t[n]));h=L(t)}!function(e){if(h){var t=vn.GetAnnotationLocalizedString("menuPropertiesButton");if(y.activeanno.get("readonly"))h.children(":contains("+t+")").off("click").children("a, div").css("color","#cdc9c9");else{var n=h.children(":contains("+t+")");void 0!==n.data("events")&&"click"in n.data("events")||n.on("click",j),n.children("a").css("color","#000000")}0===h.closest().length&&d.prepend(h);var o={x:e.x-6,y:e.y-6};h.css({left:o.x,top:o.y}),h.show(),h.visible=!0}}(e)}function H(){h&&(h.hide(),h.visible=!1)}function L(e){var t=b.createMenu(e);return t.css({position:"fixed","z-index":99999}),t.mouseleave(H),t.visible=!1,t}function B(e){return function(){return H(),e.call(this,y.activeanno.getClonedData())}}function R(){var e=y.activepage?y.activepage._index:0;if(y.annos[e]){var t=Qt.inArray(y.activeanno,y.annos[e]);-1!==t&&(y.activeanno=null,Z(t,e))}H()}function j(){H(),p.show(y.activeanno)}
/**
...
/**
   ...
   */function Z(e,t){var n=y.annos[t].splice(e,1)[0];y.activepage&&y.activepage._paper&&y.activepage._paper._annos.exclude(n.getObject()),y.activeanno===n&&(y.activeanno=null),n.dispose(),y.activepage&&y.activepage._grips&&y.activepage._grips.repaint(),l.trigger({type:"annotationdeleted",page:t,index:e})}function X(e){var t=[];if(0===y.annos.length||void 0===y.annos[e])return t;for(var n=0;n<y.annos[e].length;n++)t[n]=y.annos[e][n].getClonedData();return t}function G(e,t){if(isFinite(t)){if(t<y.annos.length)for(var n=0;n<y.annos[t].length;++n)if(y.annos[t][n].isCloneSource(e))return y.annos[t][n]}else for(var o=0;o<y.annos.length;++o){var i=G(e,o);if(i)return i}return null}function Y(e){s.annotations.defaults=e;for(var t=0;t<e.length;t++)"string"==typeof e[t].type&&(m[e[t].type]=e[t]);return l}function Q(e){s.annotations.stamps=e;for(var t=0;t<e.length;t++)ye(e[t]);if(u){var n={type:"button",id:b._id+"_toolbar_Button_Stamp",icon:"stamp",tooltip:"Draw Stamp",text:""},o=b.createDropDownButton(n);n.onclick=b.drawAnnotation,b.createDropDownMenu(o,n,e)}return l}function J(e){s.annotations.images=e;for(var t=0;t<e.length;t++)e[t].type="image";if(u){var n={type:"button",id:b._id+"_toolbar_Button_Image",icon:"image",tooltip:"Draw Image",text:""},o=b.createDropDownButton(n);n.onclick=b.drawAnnotation,b.createDropDownMenu(o,n,e)}return l}
/**
 ...
 * @name TextController
 * @memberOf Atalasoft.Controls.WebDocumentViewer
 */var wn=function e(t,n,o){var i=this,k=t,C=n,E=(n?n._internalEvents:null)||Qt({}),a={
/**
...
/**
       ...
       * @function
       */
searchOnPages:ce}};if(e.__exposedApi=a.text,!t)return null;var r=.1,l=null,S=n._pages,M={activepage:null,origin:Le(0,0),originPage:-1,rectangular:!1,selectionCache:[],searchQuery:null},u={};function F(e){return C._controllers.document.getPageText(e)}
/**
   * jQuery trigger shortcut
   * @returns object, WebDocumentViewer
   */
function s(e){return k.trigger(e),i}function p(e,t){k.trigger({type:"throwerror",name:e,msg:t})}function c(){}function A(e,t){if(t._text){f(t);var n=F(e);if(n){var o=be(t,n);if(o&&n.searchResult&&_(o,n),o&&n.selection)for(var i=n.selection,a=0;a<i.regions.length;a++)for(var r=0;r<i.regions[a].lines.length;r++)for(var l=i.regions[a].lines[r],s=0;l.words&&s<l.words.length;s++){var c=l.words[s];te(o,c.bounds.x,c.bounds.y,c.bounds.width,c.bounds.height,u.selection)}}}}function d(e){f(e.page)}function h(e){A(e.index,e.page)}function f(e){e._text&&x(e._index)}function g(e){e.page._text.attr("width",e.width).attr("height",e.height),e.page._text.width(e.width),e.page._text.height(e.height),A(e.index,e.page)}function m(){if(M.searchQuery&&M.searchQuery.iterator){M.searchQuery.iterator.dispose(),M.searchQuery=null,de();for(var e=0;e<S.length;e++)A(S[e]._index,S[e])}}function v(e){if(null==e)for(var t=0;t<C._controllers.document.getPageCount();t++)v(t);F(e)&&(C._controllers.document.updatePageText(e,null),M.selectionCache[e]&&(M.selectionCache[e]=null,C.findPageFromIndex(e)&&x(e,null)))}function b(){if(M.searchQuery=null,M.selectionCache=[],C._controllers.document.initDocumentText({pages:[]}),S)for(var e=0;e<S.length;e++)f(S[e])}function y(){for(var e=0;e<C._controllers.document.getPageCount();e++){var t=F(e);t&&t.selection&&(x(e,t,!0),t.selection=null)}M.selectionCache.length=0}
/** Clears the text selection */function x(e,t,n){for(var o=0;o<S.length;o++)if(!isFinite(e)||S[o]._index===e){t=isFinite(e)&&o===e?t:F(S[o]._index);var i=be(S[o],t);if(i){var a=C.getSourcePageSize(S[o]._index,t?t.rotation:0);i.clearRect(0,0,a.width,a.height),n&&_(i,t)}}}function _(e,t){if(t&&t.searchResult)for(var n=0;n<t.searchResult.length;n++){var o=t.searchResult[n].bounds;te(e,o.x,o.y,o.width,o.height,u.highlight)}}function w(e){var t=e.eventData,n=t.page,o=t.point;y();var i=F(n);i&&(i.selection=le(t.point,t.point),t.interval&&M.origin&&0<=M.originPage?(G(M.originPage,M.origin,n,o),t.complete=!0):(t.line||t.word)&&Math.abs(t.point.x-M.origin.x)<10&&Math.abs(t.point.y-M.origin.y)<10?(function(e,t,n,o){var i=F(e);if(i&&(n||o))for(var a=0;a<i.regions.length;a++){var r=i.regions[a];if(Se(t,r.bounds))for(var l=0;l<r.lines.length;l++){var s=r.lines[l];if(Se(t,s.bounds)){var c={region:a,line:l,bounds:s.bounds};if(o){for(var u=0;u<s.words.length;u++)if(Se(t,s.words[u].bounds))return c.word=u,c.bounds=s.words[u].bounds,Z(e,c)}else if(n)return Z(e,c)}}}}(n,o,t.line,t.word),t.complete=!0):(M.origin=t.rectangular?t.viewerPoint:t.point,M.originPage=n,M.rectangular=t.rectangular)),t.handled=!0}Qt.extend(u,o||{}),i.dispose=function(){k.unbind({pagerecycled:d,pageshown:h,zoomchanged:c,documentchanged:m}),E.off({textselectstart:w,textselectmove:B,textselectend:R}),l=k=i=null,M.searchQuery=null,M.selectionCache=[],M.activepage=null},i.removeTextLayer=function(e){return e instanceof Qt&&(e._text&&(e._text._page=null,e._text=null),!0)},i.addTextLayer=function(t){return t instanceof Qt&&(t._text=C.createDOM("canvas",t),t._text.css({width:"100%",height:"100%",position:"absolute",zIndex:0}),t._text.attr("width",t.width()).attr("height",t.height()),(t._text._page=t).on(Kt.Features.Touch?"touchstart":"mousedown",function(){var e;e=t,M.activepage=e}),t.on({pageresize:function(e){e.page=t,g(e)},pagezoom:function(e){e.page=t,g(e)}}),!0)},i.showLayer=A,i.__exposedApi=a.text,i.__getDebugInfo=function(){var e={};return Qt.extend(!0,e,{data:M,pages:S,viewport:l}),e},i.__linkText=function(){},i.clear=b,i.setViewPort=function(e){e&&(e instanceof Qt||(e=Qt(e)),l=e)},i.search=se,i.clearSelection=y,i.ensurePageTextLoaded=ge;var z,P,D,T,I,O,V,H,L=(z=G,P=k.config.mousetool.text.throttlingtreshold,V=0,H=function(){V=(new Date).getTime(),O=null,I=z.apply(D,T),O||(D=T=null)},function(){var e=(new Date).getTime();V||(V=e-P);var t=P-(e-V);return D=this,T=arguments,t<=0||P<t?(O&&(clearTimeout(O),O=null),V=e,I=z.apply(D,T),O||(D=T=null)):O||(O=setTimeout(H,t)),I});function B(e){var t=e.eventData,n=t.page,o=M.rectangular?t.viewerPoint:t.point,i=F(n);if(i)if(i.loading)t.cursor=Re.Wait;else{if(0===i.regions.length)return!(t.handled=!1);var a=C.getPageRotation(n)+i.rotation;if(i.rotatedRegions)for(var r=0;r<i.rotatedRegions.length;r++)if(Se(t.point,i.rotatedRegions[r].bounds)){a+=i.rotatedRegions[r].rotation;break}t.cursor=a%180==0?Re.Text:Re.VerticalText,t.selecting&&L(M.originPage,Qt.extend({},M.origin),n,o,M.rectangular)}return!(t.handled=!0)}function R(e){var t=e?e.eventData:{},n=!1;for(var o in M.selectionCache)if(M.selectionCache.hasOwnProperty(o)&&M.selectionCache[o].selection&&M.selectionCache[o].selection.regions.length){n=!0;break}n&&s({type:"textselected"}),M.rectangular=!1,t.handled=!0}function j(){N()}function N(){var e=C.createDiv();if(e[0]){var t=new Be("wdv-dummy-selection-trigger",{text:function(){return q()}});t.on("success",function(){t.destroy()}),t.on("error",function(){t.destroy(),p("TextCopyError")}),t.onClick({currentTarget:e[0]})}}function q(){for(var e="",t=0;t<M.selectionCache.length;t++)if(M.selectionCache[t]){var n=M.selectionCache[t].selection;if(n&&n.regions&&0<n.regions.length)for(var o=0;o<n.regions.length;o++){var i=W(n.regions[o]);i&&(e+=i)}}return e}function U(e){for(var t="",n=0;e.words&&n<e.words.length;n++)if(Oe(e.words[n],1<=n?e.words[n-1]:null)&&(t+=" "),e.words[n].text)t+=e.words[n].text;else if(e.words[n].glyphs&&e.words[n].glyphs.length)for(var o=0;o<e.words[n].glyphs.length;o++)t+=e.words[n].glyphs[o].text;return t}function W(e){for(var t="",n=0;n<e.lines.length;n++){var o=U(e.lines[n]);o&&(t+=o+"\n")}return t}function Z(e,t){var n=F(e);if(n&&t&&n.regions[t.region]){y();var o=n.regions[t.region],i=be(ve(e),n);if(qe(t.line)&&o.lines[t.line]){for(var a=o.lines[t.line],r={words:[]},l={lines:[r],bounds:Qt.extend({},o.bounds)},s=qe(t.word)&&a.words[t.word]?t.word:0,c=qe(t.endWord)&&a.words[t.endWord]?t.endWord:qe(t.word)?s:a.words.length-1,u=s;u<=c;++u){var d=a.words[u],h=!!d.glyphs.length;h&&u===s&&qe(t.glyph)?d=K(d,t.glyph,s===c&&qe(t.endGlyph)?t.endGlyph:d.glyphs.length-1):h&&u===c&&qe(t.endGlyph)&&(d=K(d,0,t.endGlyph)),r.words.push(Qt.extend({},d)),i&&te(i,d.bounds.x,d.bounds.y,d.bounds.width,d.bounds.height)}n.selection=le(Le(t.bounds.x,t.bounds.y),Le(t.bounds.right,t.bounds.bottom)),re(n.selection.regions,l),M.selectionCache[e]=n}else X(e,t.region)}}function X(e,t){y();var n=F(e);if(n&&n.regions[t]){var o=n.regions[t],i=be(ve(e),n);n.selection=le(Le(o.bounds.x,o.bounds.y),Le(o.bounds.right,o.bounds.bottom),!1);var a=Q(i,o,n.selection.origin,n.selection.point);a&&0<a.lines.length&&(re(n.selection.regions,a),M.selectionCache[e]=n)}}function G(e,t,n,o,i){var a=Math.min(e,n),r=Math.max(e,n);for(var l in M.selectionCache)if(M.selectionCache.hasOwnProperty(l)){var s=parseInt(l,10);(s<a||r<s)&&(x(s,M.selectionCache[s],!0),M.selectionCache[s].selection=null)}for(var c=i?Math.min(t.x,o.x):0,u=Le(c,0),d=a;d<=r;d++){var h=C.getSourcePageSize(d);i&&((h=Qt.extend({},C.getPageSize(d))).width*=C.getPageScale(d),h.height*=C.getPageScale(d));var f=i?Math.max(t.x,o.x):h.width,p=Le(f,h.height),g=void 0,m=void 0;a===r?(g=t,m=o):d===e?(g=t,m=d===a?p:u):d===r||d===a?(m=o,g=d===a?p:u):(g=u,m=p);var v=ve(d);i?$(d,Le(c,g.y),Le(f,m.y),v):Y(d,g,m,v)}}function Y(e,t,n,o){var i,a,r,l=F(e);if(l&&ne(l,t,n,!1)&&0<l.regions.length){o&&o._text&&x(e,l,!0),l.selection=le(t,n,!1);var s=function(e,t,n){for(var o=Le(Math.min(t.x,n.x),Math.min(t.y,n.y)),i=Le(Math.max(t.x,n.x),Math.max(t.y,n.y)),a=De({x:o.x,y:o.y,width:i.x-o.x,height:i.y-o.y}),r=De({x:0,y:o.y,width:e.bounds.width,height:i.y-o.y}),l=t,s=n,c=null,u=null,d=null,h=null,f=0;f<e.regions.length&&(!c||!u);f++){var p=e.regions[f].bounds;Me(r,p)&&(d=!d||ae(e.regions[f],d)?e.regions[f]:d),Me(a,p)&&(c=!c&&Se(l,e.regions[f].bounds)?e.regions[f]:c,u=!u&&Se(s,e.regions[f].bounds)?e.regions[f]:u,h=!h||oe(e.regions[f],h)?e.regions[f]:h)}if(c&&u){if(ae(u,c)){var g=u;u=c,c=g,l=n,s=t}}else if(d&&h){var m;c?(m=ie(s),ae(c,m)?(u=h,s=null):(u=c,s=l,c=d,l=null)):u?(m=ie(l),oe(u,m)?(c=d,l=null):(c=u,l=s,u=h,s=null)):(c=d,u=h,l=s=null),l=l||Ve(c),s=s||He(u)}return{start:c,startPoint:l,end:u,endPoint:s}}(l,t,n);if(s&&s.start&&s.end)for(var c=be(o,l),u=0;u<l.regions.length;u++){var d=l.regions[u],h=null;d===s.start?h=d===s.end?Q(c,d,s.startPoint,s.endPoint):Q(c,d,s.startPoint,He(d)):d===s.end?h=Q(c,d,Ve(d),s.endPoint):(i=d,a=s.start,r=s.end,oe(i,a)&&ae(i,r)&&(h=Q(c,d,Ve(d),He(d)))),h&&h.lines&&0<h.lines.length&&(re(l.selection.regions,h),M.selectionCache[e]=l)}}}function Q(e,t,n,o){var i={lines:[],bounds:Qt.extend({},t.bounds)},a=F(t.page).bounds;if(0!==t.rotation&&(n=Ne(n,a,360-t.rotation),o=Ne(o,a,360-t.rotation)),ke(n.y,o.y)){var r=n;n=o,o=r}for(var l=0;l<t.lines.length;l++){var s=t.lines[l],c={words:[]},u=Pe(s,a,t.rotation),d=ke(u.y,n.y)&&Te(u.bottom,o.y),h=!d&&Ee(n.y,u.y,u.bottom),f=!d&&Ee(o.y,u.y,u.bottom);if(h&&1<l){var p=Pe(t.lines[l-1],a,t.rotation);d=!(h=!Ee(n.y,p.y,p.bottom))&&!f}if(f&&l<t.lines.length-1){var g=Pe(t.lines[l+1],a,t.rotation);f=!Ee(o.y,g.y,g.bottom),d=!h&&!f}if(d||h||f){for(var m=0;s.words&&m<s.words.length;m++){var v=s.words[m],b=Pe(v,a,t.rotation),y=v.glyphs&&v.glyphs.length,x=d;if(!x){if(h&&f){if(ke(n.x,o.x)){var _=n;n=o,o=_}x=ke(y?b.x:b.right,n.x)&&Te(y?b.right:b.x,o.x)}else h?x=ke(y?b.x:b.right,n.x):f&&(x=Te(y?b.right:b.x,o.x));if(!x&&y){var w=null;if(h&&Ee(n.x,b.x,b.right)){var z=f?Math.min(b.right,o.x):b.right;w=J(v,n.x,z)}f&&Ee(o.x,b.x,b.right)&&(w=J(v,h?Math.max(b.x,n.x):b.x,o.x)),w&&(v=w,x=!0)}}x&&(c.words.push(Qt.extend({},v)),e&&te(e,v.bounds.x,v.bounds.y,v.bounds.width,v.bounds.height))}0<c.words.length&&i.lines.push(c)}}return i}function J(e,t,n){for(var o=null,i=null,a=0;a<e.glyphs.length;++a){var r=e.glyphs[a].normalizedBounds;if(null===o&&ke(r.right,t)&&(o=a),!Te(r.x,n))break;i=a}return null!==o&&null!==i?K(e,o,i):null}function K(e,t,n){var o={glyphs:[],text:"",omitSpace:e.omitSpace};if(0<=t&&t<=n&&e.glyphs[n]){o.glyphs=e.glyphs.slice(t,n+1);var i=e.glyphs[t].bounds,a=e.glyphs[n].bounds,r=Math.min(i.x,a.x),l=Math.min(i.y,a.y),s=Math.max(i.right,a.right),c=Math.max(i.bottom,a.bottom);return o.bounds={x:r,y:l,width:Math.abs(s-r),height:Math.abs(c-l)},De(o.bounds),o}return null}function $(e,t,n,o){var i=F(e);if(i&&ne(i,t,n,!0)&&0<i.regions.length){o&&o._text&&x(e,i,!0);var a=Ie(e,i,t),r=Ie(e,i,n);i.selection=le(t,n,!0);var l=De({x:Math.min(a.x,r.x),y:Math.min(a.y,r.y),width:Math.abs(r.x-a.x),height:Math.abs(r.y-a.y)});if(l=Ae(l,i.bounds)){for(var s,c=0;c<i.regions.length;c++)if(Me(l,i.regions[c].bounds)){s=s||be(o,i);for(var u={lines:[],bounds:Qt.extend({},i.regions[c].bounds)},d=0;d<i.regions[c].lines.length;d++){for(var h=i.regions[c].lines[d],f={words:[]},p=0;h.words&&p<h.words.length;p++){var g=h.words[p];if(Me(l,g.bounds)){var m=De(je(l,i.bounds,(360-i.regions[c].rotation)%360)),v=g.normalizedBounds,b=ke(v.x,m.x),y=Te(v.right,m.right);b&&y||(g=J(g,Math.max(v.x,m.x),Math.min(v.right,m.right))),g&&(f.words.push(Qt.extend({},g)),s&&te(s,g.bounds.x,g.bounds.y,g.bounds.width,g.bounds.height))}}0<f.words.length&&u.lines.push(f)}u.lines.length&&re(i.selection.regions,u)}i.selection.regions.length&&(i.selection.bounds=l,M.selectionCache[e]=i)}}}function ee(e,t){if(t){if(t.rotation%180!=0)return De({x:(e.right+e.x)/2,y:e.y,width:0,height:e.height});var n=(e.bottom+e.y)/2;return De({x:e.x,y:n,width:e.width,height:0})}return null}function te(e,t,n,o,i,a){e&&(e.clearRect(t,n,o,i),a=a||u.selection,e.fillStyle=a.color,e.globalAlpha=a.alpha,e.fillRect(t,n,o,i))}function ne(e,t,n,o){return o=!!o,!e.selection||!Ce(e.selection.origin,t)||!Ce(e.selection.point,n)||o!==e.selection.rectangular}function oe(e,t){if(ke(e.bounds.bottom,t.bounds.y)){if(Fe(e.bounds,t.bounds))return e.bounds.x>t.bounds.x;var n=Ae(e.bounds,t.bounds);if(n)return 1<=n.width/n.height?ke(e.bounds.y,t.bounds.y):ke(e.bounds.x,t.bounds.x);if(ke(e.bounds.y,t.bounds.bottom))return!0;if(Te(e.bounds.bottom,t.bounds.y))return!1;if(ke(e.bounds.x,t.bounds.x))return!0}return!1}function ie(e){return{lines:[],bounds:De({x:e.x,y:e.y,width:0,height:0})}}function ae(e,t){return!oe(e,t)}function re(e,t){for(var n=0;n<e.length&&!ae(t,e[n]);n++);Array.prototype.splice.call(e,n,0,t)}function le(e,t,n){return{origin:e,point:t,rectangular:!!n,regions:[]}}function se(e,t,n){return"function"==typeof t&&(n=t,t=0),ce(e,0,C._controllers.document.getPageCount()-1,t,n)}function ce(e,t,n,o,i){var a=this,r=C._controllers.document.getPageCount(),l=!1,s=function(e,t){if(Ue(this,a),l)return null;var n=!1,o=e;return"string"==typeof e&&(o=Je(e),n=!0),null===o&&!n||void 0===o||"number"==typeof o?o:(p("searchOnPages",t+" page '"+JSON.stringify(e)+"' is not a correct page index."),l=!0,null)}.bind(this),c=s(t,"Start"),u=s(n,"End"),d=s(o,"Active");if(l)return null;if(hn(c)||(c=0),hn(u)||(u=r-1),hn(d)||(d=c),c<0||r<=c)return p("searchOnPages","Start page "+c+" is out of range."),null;if(u<0||r<=u)return p("searchOnPages","End page "+u+" is out of range."),null;if(u<c)return p("searchOnPages","Start page is greater than end page."),null;if(d<c||u<d)return p("searchOnPages","Active page "+d+" is out of range."),null;if(null!=e&&"string"!=typeof e)return p("searchOnPages","Text to search value "+JSON.stringify(e)+" is not a valid text to search."),null;if(null!=i&&"function"!=typeof i)return p("searchOnPages","Callback value "+JSON.stringify(i)+" is not a valid callback function."),null;if(de(),e&&2<e.length&&i){var h={sourceQuery:e,text:e.toLocaleLowerCase(),start:c,end:u,active:d},f=new ue(M.searchQuery=h,i);return M.searchQuery.iterator=f}return S.forEach(function(e){Ue(this,a),e._index>=c&&e._index<=u&&A(e._index,e)}.bind(this)),null}
/**
...
/**
   ...
   */function ue(c,o){var u,d=3,h=c.start,f=c.end,p=c.active,g=-1,m=-1,v=0,b=this,y=[],t=[],x=T(-1);function i(e){t.push({action:_,args:[!0,D(e)]}),n()}
/**
     ...
     */function n(){if(!u&&t.length){var e=t.shift();e&&"function"==typeof e.action&&e.action.apply(b,e.args)}}function _(n,o){if(w()){var e=n?1:-1,t=F(g);if(t&&t.searchResult&&t.searchResult.length&&(n?-1<=m&&m<v-1:0<m&&m<=v)){m+=e;var i=t.searchResult[m];x=T(g,i),Z(g,i);var a=t?t.rotation:0,r=C.getViewerTransform(g,a),l=ee(i.bounds,t.regions[i.region]),s=Le(r.x(l.x,l.y),r.y(l.x,l.y));C.showPagePoint(g,s,nn.Center,function(){o(b,T(g,i))})}else u=u||z(c.text,0<=g?g+e:p,n).done(function(e,t){w()?0<=e&&t&&(g=e,v=t.searchResult.length,m=n?-1:v,_(n,o)):o(b,null)}).fail(function(){o(b,null)})}else o(b,null)}
/**
...
/**
       ...
       * @type {boolean}
       */
b.wrap=!0,E.on("pagetextloaded",e),k.bind({pageshown:r}),setTimeout(function(){for(var e=0;e<S.length;e++){var t=S[e]._index;if(!(t<h||f<t)){var n=F(t);n&&!n.loading&&(n.searchResult=P(n,c.text),n.searchResult.length&&(A(t,S[e]),t===p&&(v=n.searchResult.length,g=p)))}}i(o)},0),
/**
...
/**
     ...
     */,b.getCurrentLineText=function(){if(w()&&x&&0<=x.page){var e=F(x.page);if(e&&e.regions[x.region]&&e.regions[x.region].lines[x.line])return U(e.regions[x.region].lines[x.line])}return null},
/**
 ...
 */function Se(e,o){if(!ln())return null;var t,c={typeOf:e.type||"Atalasoft.Controls.WebDocumentViewer"},s="",k=150,u=500,y="atala-ui-icon",n=document.createElement("div"),i=Qt({}),a=Qt({}),r=new pn({get:function(){return c},isInitialized:At,switchDocument:gt,closeDocument:mt}),x={
...
status:null,
/** Upload control*/
uploadCtrl:null},C={annotations:null,document:null,forms:null,mouseTool:null,memory:null,text:null,upload:null},E={size:{width:0,height:0},sizes:[{width:0,height:0}],smallest:{width:0,height:0},count:0,number:-1,numberoutof:-1,buffer:3,dpi:96,vector:!1,caption:"",customData:null},S={prpr:0,batchoperation:0,loading:!1,zooming:!1,initialized:!1,newpagedivsize:null,newpagedivfullzoom:1,scrollPos:{x:0,y:0,t:0},scrollBuffer:null,scrollTimeout:null,activepage:null,nextImageCacheIndex:0},d={
/**
...
c.domclasses=an,
/** WARNING: Changing values from these references can cause instability.*/
c.domattributes=rn;var N=function(e){return[e.number-1]};function q(e,t){var n=A(e,t);return M.direction===en.Vertical?(n.height(1),n.css({display:"block"})):M.direction===en.Horizontal&&(n.width(1),n.css({display:"inline-block",overflow:"hidden"})),n._zoom=1,M.backcolor&&n.css({backgroundColor:M.backcolor}),n}function U(e){if(void 0===e){var t=Y(J());E.buffer<t&&(E.buffer=t),E.buffer=Math.min(E.buffer,C.document.getPageCount()),e=E.buffer}function n(t){return function(){var e;e=t,S.activepage=e}}if(x.pageDivs.length<e)for(var o=x.pageDivs.length;o<e;o++)x.pageDivs[o]=A(),x.pageDivs[o].addClass(an.atala_page_div),M.showselecttools&&(x.pageDivs[o]._rubberband=new Pn(c,{},x.pageDivs[o],{getViewportSize:ue,getMaxZoom:K,getPageOffsets:ae,raiseDrawLayer:ft,resetDrawLayer:pt})),x.pageDivs[o].on({touchstart:n(x.pageDivs[o]),mousedown:n(x.pageDivs[o])}),C.annotations&&C.annotations.addDrawingSurface(x.pageDivs[o]),(M.showselecttools||M.allowannotations||M.allowforms||M.allowtext)&&(x.pageDivs[o]._draw=z(x.pageDivs[o])),C.forms&&C.forms.addFormLayer(x.pageDivs[o]),C.text&&C.text.addTextLayer(x.pageDivs[o]);else if(x.pageDivs.length>e)for(;x.pageDivs.length>e&&0!==x.pageDivs.length;){var i=x.pageDivs.pop();i._rubberband&&i._rubberband.dispose(),C.annotations&&C.annotations.removeDrawingSurface(i),C.forms&&C.forms.removeFormLayer(i),C.text&&C.text.removeTextLayer(i),i&&Ae(i),i=null}}function W(e,r,t,n){"function"==typeof t&&(n=t,t=void 0);var o="function"==typeof n?[n]:[],u=Qt(new Image),i=.9,l=Qt.extend(!0,{atala_cb:void 0},t||{});u._domEl=A(),u._domEl.addClass(an.atala_page_image_anchor),u.addClass(an.atala_page_image),u._domEl.append(u);var a={load:v,error:function(){z(),F("ImageError","Image at frameIndex "+d()+" failed to load.")},inserted:function(){u._loaded&&b()}};function d(){return u._page?u._page._index:C.document.getPageIndexByImageIndex(u._index)}function s(){return u._domEl}function c(e){return C.document.getPageFitMultiplier(void 0!==e?e:d())}function h(e,t){return(e=void 0===e?M.zoom:e)*c(t)}function f(){var e=ce(d())||E.size;return{height:e.height,width:e.width}}
/**
     * Returns physical size of the image without client transformations applied(like view rotation)
     */function p(){var e=f();return 90===u._viewrotation||270===u._viewrotation?T(e):e}function g(e,t){return t=t||f(),{height:Math.round(t.height*h(e)),width:Math.round(t.width*h(e))}}function m(e){var t=d(),n=E.vector&&(!r||!r.uri)?h():Math.min(h(),1),o=C.document.getPageRotation(t);if(e||n!==u._zoom||u._rotation!==o){var i=Qt.extend({atala_docurl:r?r.uri:u.documenturl,atala_doczoom:n,atala_thumbpadding:!1},l);o&&(i.atala_angle=o),M.jpeg&&(i.atala_jpeg=!0);var a={type:"docpage",serverurl:M.serverurl,query:"?ataladocpage="+(null===r?u._index:void 0!==r.index?r.index:r),method:"GET",data:i,cancel:!1,info:u};u._reqzoom=n,u._reqangle=o,St(a,v,v)}}function v(){u._loaded||u._domEl.removeClass(an.atala_page_loading),u._loaded=!0,u._zoom=u._reqzoom,u._rotation=u._reqangle;var e=d();if(0<=e){if(u._rotation!==C.document.getPageRotation(e))return void m();(u._viewrotation=0)<u.parent().length&&b(),D(u._viewrotation);var t=E.vector?h():Math.min(h(),1);x()&&u._zoom<t*i&&!Q(u._zoom,t)&&y(!1)}z()}function b(){var e;(e=u)&&(e.removeAttr("width height"),e.css({width:"auto",height:"auto"}));var t=u.prop("naturalWidth")||0,n=u.prop("naturalHeight")||0,o=t||u.width(),i=n||u.height(),a=f(),r=h(),l=!1;if(0!==o&&0!==i){var s;u._size.width=Math.round(o/u._zoom),u._size.height=Math.round(i/u._zoom),90!==u._viewrotation&&270!==u._viewrotation||(u._size=T(u._size)),u._size.width===E.size.width&&u._size.height===E.size.height||Q(u._size.width,a.width)&&Q(u._size.height,a.height)||(l=!0,C.document.setPageSize(d(),u._size)),null===C.document.getPageSize(d())&&(l=!0,C.document.setPageSize(ce,u._size)),M.forcepagefit?(s=function(e){e=e||u._size;var t={width:M.forcepagesize.width*M.zoom,height:M.forcepagesize.height*M.zoom};return(t.width<1||t.height<1)&&(t.width=E.size.width*M.zoom,t.height=E.size.height*M.zoom),e.width/t.width>e.height/t.height?t.width/e.width:t.height/e.height}()/M.zoom,C.document.setPageFitMultiplier(d(),s),w()):(u._zoom!==M.zoom||l||0!==u._viewrotation)&&w();var c=g();l&&u.trigger({type:"pagesizechanged",image:u,index:d(),width:u._size.width,height:u._size.height,dx:Math.round(c.width-a.width*r),dy:Math.round(c.height-a.height*r)}),u.trigger({type:"pageresize",image:u,index:d(),width:c.width,height:c.height})}}function y(e,t){x()&&!u._size.isEmpty()?("function"==typeof t&&o.push(t),u._prevzoom=u._reqzoom,e&&!S.loading?u.animate({height:Math.round(u._size.height*h()),width:Math.round(u._size.width*h())},{duration:k,easing:"easeOutQuad",complete:_,queue:!1}):(w(),_())):"function"==typeof t&&t.call(this,u)}function x(){if(!u._loaded)return!1;var e=!E.vector&&1===u._reqzoom&&1===u._prevzoom&&1<h(),t=Q(u._reqzoom,h())||e;if(!t){var n=Math.abs(u._reqzoom*u._size.width-h()*u._size.width),o=Math.abs(u._reqzoom*u._size.height-h()*u._size.height);n<1&&o<1&&(t=!0)}return!t||!Q(u._scaledzoom,h())}function _(){u.trigger({type:"pagezoom",index:d(),height:Math.round(u._size.height*h()),width:Math.round(u._size.width*h()),prevzoom:u._prevzoom,zoom:h()}),0===S.prpr?m():z()}function w(){var e,t,n,o=g(void 0,p()),i=g(),a=u.prop("naturalWidth")||0,r=u.prop("naturalHeight")||0,l=a&&Math.abs(a-o.width)/o.width<.01,s=r&&Math.abs(r-o.height)/o.height<.01;l&&s||(u.height(o.height),u.width(o.width)),u._domEl.width(i.width),u._domEl.height(i.height),u._scaledzoom=h(),D(u._viewrotation),e=d(),t=i.width,i.height,null!=(n=je(e))&&null!=n._num&&n._num.css({left:t-20,right:0})}function z(){0<o.length&&function(e){var t=Array.prototype.slice.call(arguments,1);for(;e.length;)e.shift().apply(this,t)}(o,u)}function P(){var e=C.document.getPageRotation(d());return 0===u._viewrotation&&e!==u._rotation||0!==u._viewrotation}function D(e){var t=g(void 0,p()),n=0,o=0,i="";90!==e&&270!==e||(n=(t.height-t.width)/2,o=(t.width-t.height)/2,t=T(t)),0!==e?(i+=" translate("+n+"px,"+o+"px)",i+="rotate("+e+"deg)",u.css(dn(i))):u.css(dn("")),s().css({width:t.width,height:t.height}),u._viewrotation=e}function T(e){var t=e.width;return e.width=e.height,e.height=t,e}return u._binds=a,u.documenturl=M.documenturl,u._index=r?r.mapsto:e,u._loaded=!1,u._size={width:0,height:0,isEmpty:function(){return 0===this.width&&0===this.height}},u._zoom=-1,u._prevzoom=u._zoom,u._scaledzoom=-1,u._rotation=0,u._viewrotation=0,u.dispose=function(){u.off(a),u._page=null,u=null},u.zoom=y,u.needsZoom=x,u.getSize=f,u.getScaledSize=g,u.getFitZoom=h,u.getFitMultiplier=c,u.needsRotate=P,u.rotate=function(e){"function"==typeof e&&o.push(e);if(P()){var t=C.document.getPageRotation(d());if(n=C.document.getPageRotation(d()),(0===u._viewrotation&&n!==u._rotation||0!==u._viewrotation&&(u._viewrotation+u._rotation)%360!==n)&&u&&u._loaded&&u._page&&(D(t=(360+t-u._rotation)%360),b()),0===S.prpr&&u._loaded)return void m()}var n;z()},u.getDomElement=s,u.invalidate=function(e,t){"function"==typeof e&&(t=e,e={});(l=Qt.extend(!0,{},e)).atala_cb=Math.floor(1e9*Math.random()),"function"==typeof t&&o.push(t);m(!0)},function(){u.on(a);var e=M.pageborderwidth,t={bottom:0,top:0,right:0,left:0};u._loaded=!1,u._reqzoom=-1,M.direction===en.Vertical&&(t.bottom=M.pagespacing);M.direction===en.Horizontal&&(t.right=M.pagespacing);var n=s();M.showpageborder&&n.css({"border-bottom":e+"px solid black","border-right":e+"px solid black","border-top":e+"px solid silver","border-left":e+"px solid silver","margin-bottom":t.bottom+"px","margin-right":t.right+"px"});n.css({display:"inline-block"}),n.addClass(an.atala_page_loading),m()}(),u}function Z(e,t){var n="overflow:scroll; position:absolute; background-color:Transparent;",o=A(e);o.css({position:"absolute",display:"none","background-color":"white"});var i=null,a=!1;function r(){i._tooltip.hide(),E.number===i._pagenum||Re(i._pagenum)||Ce(i._pagenum),Dt()}return t===en.Horizontal?(Kt.Firefox&&(n=n.replace("overflow","overflow-x")),(i=Qt('<div style="'+n+'bottom:0px; left:0px; width:100%;z-index:10"></div>').appendTo(e))._tray=Qt('<div style="height:1px;"></div>').appendTo(i)):(Kt.Firefox&&(n=n.replace("overflow","overflow-y"),n+="width:"+(function(){var e=A(Qt("body")),t=A(e);e.css({width:"50px",height:"50px",overflow:"hidden",position:"absolute",visibility:"hidden"}),t.css({width:"100px",height:"100px"});var n=e.width();e.css({"overflow-y":"scroll"});var o=n-e[0].clientWidth;return Qt(e).remove(),o}()+1)+"px;",a=!0),(i=Qt('<div style="'+n+'top:0px; right:0px; height:100%;z-index:10"></div>').appendTo(e))._explicitSize=a,i._tray=Qt('<div style="width:1px;"></div>').appendTo(i)),G(i),i._ratio=1,i.ScrollDirection=t,i._tooltip=o,i._pagenum=-1,i._scrollSize=0,i.pageNum=function(e){i._pagenum=e},i.scrollbarHeight=function(){return i.height()-i[0].clientHeight},i.scrollSize=function(e){i._scrollSize=e},i.ratio=function(e){i._ratio=e},i.on({scroll:function(){if(!i.propagationPaused()){clearTimeout(i._tooltip._timeout),x.scroller.stop(),x.scroller.pauseEventPropagation(!0);var e={};i.ScrollDirection===en.Vertical?(x.scroller.scrollTop(i[0].scrollTop*i._ratio),i._pagenum=Lt()+1,e.right=i.outerWidth()+10+"px",e.top=16+Math.round((i[0].offsetHeight-48)/i[0].scrollHeight*i[0].scrollTop)+"px"):i.ScrollDirection===en.Horizontal&&(x.scroller.scrollLeft(i[0].scrollLeft*i._ratio),i._pagenum=Lt()+1,e.bottom=i.outerHeight()+10+"px",e.left=16+Math.round((i[0].offsetWidth-48)/i[0].scrollWidth*i[0].scrollLeft)+"px"),i.ScrollDirection===M.direction&&M.showpagenumbertooltip&&("none"===i._tooltip.css("display")&&(i._tooltip.css(e),i._tooltip.show()),M.showpagenumbertooltip&&i._tooltip.html("Page "+i._pagenum),i._tooltip._timeout=setTimeout(r,1e3))}}}),i}function X(e){e&&e._tooltip&&(clearTimeout(e._tooltip._timeout),e._tooltip.hide())}function G(t){var n={scroll:function(){t.off(n),t.resumeEventPropagation()}};t._pauseEP=0,t.propagationPaused=function(){return 0<t._pauseEP},t.pauseEventPropagation=function(e){t._pauseEP++,e&&t.on(n)},t.resumeEventPropagation=function(){0<t._pauseEP&&t._pauseEP--}}function Y(e){var t=ue(),n=$(0,e);n.width=0<E.smallest.width&&E.smallest.width<n.width?E.smallest.width:n.width,n.height=0<E.smallest.height&&E.smallest.height<n.height?E.smallest.height:n.height;var o,i=Math.ceil(t.width/n.width)+2,a=Math.ceil(t.height/n.height)+2;return M.direction===en.Vertical?o=a:M.direction===en.Horizontal&&(o=i),o}function Q(e,t){return t<e+.001&&e-.001<t}function J(){return 0!==E.size.width?M.minwidth/E.size.width:1}function K(){return 0!==E.size.width?M.maxwidth/E.size.width:1}function $(e,t,n){if(C.document.getPageCount()<=0)return{width:0,height:0};if(n=void 0===n||n,S.newpagedivsize){var o={width:S.newpagedivsize.width,height:S.newpagedivsize.height},i=M.showpageborder&&n?2*M.pageborderwidth:0,a=(t||M.zoom)/S.newpagedivfullzoom;return o.height=Math.round(o.height*a)+i,o.width=Math.round(o.width*a)+i,o}return ee(e,t||M.zoom,M.showpageborder&&n)}function ee(e,t,n){var o,i=Qt.extend({},ce(e)),a=n?2*M.pageborderwidth:0;return t*=(o=e,C.document.getPageFitMultiplier(o)),i.height=Math.round(i.height*t)+a,i.width=Math.round(i.width*t)+a,i}function te(e,t){return ae(null,e,t).index}function ne(e,t){for(var n={left:0,top:0},o=e;null!=o&&o!==t;o=o.offsetParent)n.left+=o.offsetLeft,n.top+=o.offsetTop;return n}var oe={height:0,isEmpty:function(){return 0===this.width&&0===this.height},width:0,zero:function(){this.width=0,this.height=0},zoom:1};function ie(){if(oe.isEmpty()||oe.zoom!==M.zoom){var e=ae(null,null,null,M.zoom);oe.height=e.height,oe.width=e.width,oe.zoom=M.zoom}return oe}function ae(e,t,n,o){return re(0,e,t,n,o)}function re(e,t,n,o,i){var a={height:0,width:0,index:0};if(M.direction===en.Vertical)for(var r=null,l=0;l<1&&l<0&&(a.height+(r=$(l,i).height)<=o||null==o);l++)a.height+=r+M.pagespacing,a.index++;else if(M.direction===en.Horizontal)for(var s=null,c=0;c<1&&c<0&&(a.width+(s=$(c,i).width)<=n||null==n);c++)a.width+=s+M.pagespacing,a.index++;return 1<=a.index&&(a.index=0),a}function le(){return 1}function se(e,t){var n=ce(e);return(lt(e)+(t||0))%180==0?n:{width:n.height,height:n.width}}function ce(e){var t=C.document.getPageSize(e);return t||E.size}function ue(){return{width:x.scrollV?x.main.width()-x.scrollV.outerWidth():x.main.width(),height:x.scrollH?x.main.height()-x.scrollH.outerHeight():x.main.height()}}function de(e,t){var n={status:"fail",started:!1,reason:e};return"function"==typeof t&&t.call(),n}function he(e,t,n,o,i,a){var r=ne(e,t);return r.left<=i&&r.left+e.clientWidth>=n&&r.top<=a&&r.top+e.clientHeight>=o}function fe(e){M.showstatus&&x.status&&x.status.html(e),jt({type:"statusmessage",message:e})}function pe(e,t){var n;if(1===e.length&&"object"==typeof e[0])n=e[0];else if("string"==typeof e[0]){n={};var o=null;3===e.length?o=e[2]:2===e.length&&(o=e[1]);for(var i=-1<e[0].indexOf(" ")?e[0].split(" "):[e[0]],a=0;a<i.length;a++)n[i[a]]=o}for(var r in n)if(n.hasOwnProperty(r)){var l=null;if(r in d?l=d:c&&r in c.annotations.events?l=c.annotations.events:c&&r in c.forms.events?l=c.forms.events:c&&r in c.document.events&&(l=c.document.events),null==l&&(l=d),null==l[r])t&&(l[r]=[n[r]]);else if(t)l[r].push(n[r]);else if(n[r])for(var s=0;s<l[r].length;s++)l[r][s]===n[r]&&l[r].splice(s,1);else l[r].length=0}}function ge(e,t){return t?isFinite(parseFloat(e)):isFinite(parseInt(e,10))}function me(e,t,n,o,i){if(null==i&&"function"==typeof o&&(i=o,o=null),e=null==e?x.scroller.scrollLeft():e,t=null==t?x.scroller.scrollTop():t,M.direction===en.Horizontal){if(e>x.viewport.width()){var a=ie();if(e<a.width&&0<x.content.width()){var r=a.width-(x.edges[0].width()+x.content.width());x.edges[1].width(r)}}}else if(M.direction===en.Vertical&&t>x.viewport.height()){var l=ie();if(t<l.height&&0<x.content.height()){var s=l.height-(x.edges[0].height()+x.content.height());x.edges[1].height(s)}}x.scroller.stop(),!n||S.loading||S.scrollPos.x===e&&S.scrollPos.y===t?(x.scroller.scrollLeft(e),x.scroller.scrollTop(t),"function"==typeof i&&i.call()):Qt.when(x.scroller.animate({scrollLeft:e,scrollTop:t},{duration:o||u,easing:"easeOutQuad",queue:!1})).done(i)}function ve(){if(x.scrollH&&x.scrollV){if(x.scrollH.pauseEventPropagation(),x.scrollV.pauseEventPropagation(),M.direction===en.Vertical){be(x.scrollH,"width");var e=Math.round(ae(0).height+$(Lt()).height);Kt.Firefox&&(e+=Math.round(x.scrollH.scrollbarHeight())),x.scrollV.scrollSize(e-(x.scrollV.height()-x.scrollH.scrollbarHeight()-1)),3e4<e?(x.scrollV.ratio(e/(3e4-(x.scrollV.height()-x.scrollH.scrollbarHeight()-1))),x.scrollV._tray.height(3e4)):(x.scrollV._tray.height(e),x.scrollV.ratio(1)),ye(x.scrollV)}else if(M.direction===en.Horizontal){be(x.scrollV,"height");var t=Math.round(ae(0).width+$(Lt()).width);x.scrollH.scrollSize(t),3e4<t?(x.scrollH.ratio(t/(3e4-(x.scrollH.width()-x.scrollV.width()-1))),x.scrollH._tray.width(3e4)):(x.scrollH._tray.width(t),x.scrollH.ratio(1)),ye(x.scrollH)}x.scrollV._max=Math.max(x.scrollV._tray.height()-x.scrollV.height(),0)+1,x.scrollH._max=Math.max(x.scrollH._tray.width()-x.scrollH.width(),0)+1,x.scrollH.resumeEventPropagation(),x.scrollV.resumeEventPropagation()}}function be(e,t){if(e&&x.pageDivs.length){for(var n=Math.round(E.size[t]*M.zoom),o=0;o<1;o++)null!=x.pageDivs[o]._index&&(n=Math.max($(x.pageDivs[o]._index)[t],n));e._tray[t](n),e.scrollSize(n-e[t]()),ye(e),e.ratio(1)}}function ye(e){e&&(e._scrollSize<=0?e._tray.hide():e._tray.show())}function xe(e){if(!S.zooming&&!S.scrollBuffer&&x.pageDivs.length){var t=(new Date).getTime(),a=x.scroller[0].scrollLeft,r=x.scroller[0].scrollTop;if(S.loading||ot(),Se(E.number),!x.scroller.propagationPaused()&&x.scrollH&&x.scrollV){var n=Math.round(a/x.scrollH._ratio),o=Math.round(r/x.scrollV._ratio);n!==x.scrollH.scrollLeft()&&(x.scrollH.pauseEventPropagation(!0),x.scrollH.scrollLeft(n)),o!==x.scrollV.scrollTop()&&(x.scrollV.pauseEventPropagation(!0),x.scrollV.scrollTop(o))}jt({type:"scroll",x:a,y:r,dx:a-S.scrollPos.x,dy:r-S.scrollPos.y}),e&&(S.scrollTimeout&&clearTimeout(S.scrollTimeout),S.scrollTimeout=setTimeout(function(){var e,t,n,o,i;e=a,t=r,n=x.scroller[0].scrollLeft,o=x.scroller[0].scrollTop,i=n===S.scrollPos.x&&o===S.scrollPos.y,e===S.scrollPos.x&&t===S.scrollPos.y&&i?(Dt(),S.scrollTimeout=null,S.loading||ot()):i||(xe({}),S.scrollTimeout=null)},500),S.scrollPos.x=x.scroller[0].scrollLeft,S.scrollPos.y=x.scroller[0].scrollTop,S.scrollPos.t=t),S.scrollBuffer=e?setTimeout(_e,50):null}}function _e(){null!==S.scrollBuffer&&(clearTimeout(S.scrollBuffer),S.scrollBuffer=null)}function we(){if(M.direction===en.Horizontal){var e=x.pageDivs.length?E.size.height*M.zoom:0;M.thumbpadding&&"number"==typeof M.thumbpadding&&(e+=2*M.thumbpadding),x.edges[0].height(e),x.edges[1].height(e)}}function ze(e,t){t=0;var n=ae(0),o=t<1?$(t):{width:0,height:0},i=t<0?$(Lt()):{width:0,height:0},a=re();a.width+=o.width,a.height+=o.height;var r=re();if(r.width+=i.width,r.height+=i.height,M.direction===en.Vertical)if(x.edges[0].height(n.height),1<=t+1){var l=n.height+a.height+r.height;x.scrollH&&l>x.scroller[0].clientHeight&&x.content.width()<=x.scroller[0].clientWidth?x.edges[1].height(x.scrollH.scrollbarHeight()):x.edges[1].height(0)}else x.edges[1].height(r.height),Kt.Chrome&&x.content.height("");else if(M.direction===en.Horizontal)if(x.edges[0].width(n.width),1<=t+1){var s=n.width+a.width+r.width;x.scrollV&&s>x.scroller[0].clientWidth&&x.content.height()<=x.scroller[0].clientHeight?x.scrollV._explicitSize?x.edges[1].width(x.scrollV.height()<x.scrollV._tray.height()?x.scrollV.width():0):x.edges[1].width(x.scrollV.width()):x.edges[1].width(0)}else x.edges[1].width(r.width),x.edges[1].height(1)}function Pe(){return S.activepage}function De(e,t){e=e||1,ke(Lt()-e,t)}function Te(e,t){e=e||1,ke(Lt()+e,t)}
/**
...
/**
   ...
   */function Ce(e,t){e=Math.max(1,e),Ee(e=Math.min(C.document.getPageCount(),e),!1,t)}function Ee(e,t,n){var o=C.document.getPageCount(),i=e-1;if(0===S.prpr&&0<o){if(Ve(),M.direction===en.Vertical){var a=ae(0).height;x.edges[0].height(a)}else if(M.direction===en.Horizontal){var r=ae(0).width;x.edges[0].width(r)}ze(0,null),we(),Me();for(var l=0;l<x.pageDivs.length;l++)Ie(x.pageDivs[l],null,i+l);x.content.append(x.pageDivs[0]),Dt(),Se(i+1),ot(!1,function(){ve(),He(),"function"==typeof n&&n.call()})}else de("paused",n)}function Se(e){var t=C.document.getPageCount();if(0<e&&e<=t){if(E.number!==e||E.numberoutof!==t){if(x.pageLabel.html(e+" / "+t),E.number!==e){E.number=e;for(var n=0;n<x.pageDivs.length;n++){var o=x.pageDivs[n];o._index===e-1?o.addClass(an.atala_active_page):o.removeClass(an.atala_active_page)}jt({type:"pagenumberchanged",number:E.number})}E.numberoutof!==t&&(E.numberoutof=t)}}else x.pageLabel.html(""),x.viewport.find("."+an.atala_active_page).removeClass(an.atala_active_page),E.numberoutof=0}function Me(){for(var e=x.pageDivs.length-1;0<=e;e--)Fe(x.pageDivs[e])}function Fe(e){Kt.Explorer&&document.activeElement&&e.has(document.activeElement).length&&x.scroller.focus(),M.allowannotations&&(Kt.Firefox||Kt.Edge)&&C.annotations.__clearAllSelection(e),e.detach(),null!=e._img&&(e._img._page=null,e._img.getDomElement().detach(),e._img=null),jt({type:"pagerecycled",index:e._index,page:e}),e._index=-1,e.removeAttr(rn.atala_page_index)}function Ae(e){Fe(e),e._index=-1,e.removeAttr(rn.atala_page_index),e._img=null,e.remove()}function Ie(t,e,n,o){if(t._index===n&&t._img===e&&!o)return!1;if(o&&!t.nullinserted&&n<0)return!1;if(t._index=n,t.attr(rn.atala_page_index,n),n>=C.document.getPageCount())return t.hide(),!1;if(t._img&&t._img!==e&&(t._img._page=null,0<t.has(t._img.getDomElement()).length&&t._img.getDomElement().detach(void 0,!0)),t._rubberband&&t._rubberband.reset(),t._img=e,t._img&&(t._img._page=t),t.css({display:M.direction===en.Horizontal?"inline-block":"block"}),M.showpagenumber&&(t.css({position:"relative"}),t._num||(t._num=Qt('<div style="position:absolute; right:20px; bottom:16px;z-index:1"/>'),t._num.addClass(an.atala_page_number),t.append(t._num)),t._num.text(t._index+1)),t._img&&t._img._binds&&(t._img._binds.pageresize||(t._img._binds.pageresize=function(e){jt({type:"pageresize",page:e.image._page,image:e.image,index:e.image._page?e.image._page._index:C.document.getPageIndexByImageIndex(e.image._index),width:e.width,height:e.height})},t._img.on({pageresize:t._img._binds.pageresize})),t._img._binds.pagesizechanged||(t._img._binds.pagesizechanged=function(e){jt({type:"pagesizechanged",page:t,image:e.image,index:e.index,width:e.width,height:e.height,dx:e.dx,dy:e.dy})},t._img.on({pagesizechanged:t._img._binds.pagesizechanged}))),t._img){var i=t._img.getDomElement();t.append(i),t._img.trigger({type:"inserted",page:t}),t._img._loaded||(t.nullinserted?t._img.css({width:t.width(),height:t.height()}):Oe(t._img,t._index)),S.newpagedivsize||t.css({width:"",height:""}),t.nullinserted=!1}else t.nullinserted=!0,S.newpagedivsize||Oe(t,t._index);return jt({type:"pageshown",page:t,index:t._index}),!0}function Oe(e,t){var n=$(t,null,!1);e.css({width:n.width,height:n.height})}function Ve(){S.prpr++}function He(){0!==S.prpr&&(S.prpr--,0===S.prpr&&xe())}
/**
...
/**
   ...
   */
function Le(e,t){var n=Qt.Deferred();0<=e.cacheIndex&&x.loadedImgs[e.cacheIndex]?x.loadedImgs[e.cacheIndex].invalidate(t,function(){n.resolve()}):n.resolve();return n.promise()}function Be(e,t,n){"function"==typeof t&&(n=t,t=void 0);var o=C.document.getPageDefinition(e);if(o){if(o.cacheIndex<0||!x.loadedImgs[o.cacheIndex]){var i=S.nextImageCacheIndex++;o.cacheIndex=i,C.document.setPageCacheIndex(e,i),x.loadedImgs[i]=W(o.index,o.ref,t,function(e){e&&((x.loadedImgs[i]=e)._cacheIndex=i,C.memory.allocate(e)),"function"==typeof n&&n.call()}),M.allowtext&&C.text&&C.text.ensurePageTextLoaded(e)}else"function"==typeof n&&n.call();return x.loadedImgs[o.cacheIndex]}}function Re(e){var t=je(e);if(t){var n=x.scroller[0].scrollLeft,o=x.scroller[0].scrollTop;return he(t[0],x.scroller[0],n,o,n+x.scroller[0].clientWidth,o+x.scroller[0].clientHeight)}return!1}function je(e){for(var t=null,n=0;n<x.pageDivs.length&&null===t;n++)x.pageDivs[n]._index===e&&(t=x.pageDivs[n]);return t}function Ne(e,a,r,l,s){var c=this;l&&"function"==typeof l&&(s=l,l=!1);var t=function(){Nt(this,c);var e,t=x.pageDivs[0];if(t){var n=x.scroller[0].scrollLeft,o=x.scroller[0].scrollTop;if((e=ne(t[0],x.scroller[0])).left+=a.x,e.top+=a.y,!l&&e.left>=n&&e.left<=n+n+x.scroller[0].clientWidth&&e.top>=o&&e.top<=o+x.scroller[0].clientHeight)return void(s&&s())}else(e=ae(0)).left=e.width+a.x,e.top=e.height+a.y;var i={x:x.scroller[0].clientWidth/2,y:x.scroller[0].clientHeight/2};qe(r,nn.BottomLeft)?(i.x=x.scroller[0].clientWidth,i.y=x.scroller[0].clientHeight):qe(r,nn.TopLeft)&&(i.x=0,i.y=0),me(e.left-i.x,e.top-i.y,!0,s)}.bind(this);e!==Lt()?Ee(e+1,0,t):t()}function qe(e,t){return e&&t&&e.x===t.x&&e.y===t.y}var Ue=null;function We(){Ue&&clearTimeout(Ue),Ue=setTimeout(function(){jt("documentchanged")},200)}function Ze(){x.scroller.stop(),x.scroller.pauseEventPropagation(),Ve()}function Xe(){ve(),0<x.pageDivs.length&&Re(Lt())&&ze(x.pageDivs[0]._index),we(),x.scroller.resumeEventPropagation(),He()}function Ge(){S.zooming=!0,Ze(),jt("zoomstarted")}function Ye(e){var t,n,o,i,a,r,l;e=Math.min(e,K()),e=Math.max(e,J()),t=e,n=!1,i=ae(E.number,null,null),a=ae(E.number,null,null,t),r=(x.scroller.scrollLeft()-i.width)/M.zoom*t,l=(x.scroller.scrollTop()-i.height)/M.zoom*t,me(a.width+r,a.height+l,n,k,o),M.zoom=e,ot(!1),tt(e,!1)}function Qe(){S.zooming=!1,Xe(),jt({type:"zoomchanged",zoom:M.zoom})}
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function zoom
   */function Je(e,n){var o=this;if(S.zooming)de("zooming",n);else if(S.zooming=!0,Ze(),jt("zoomstarted"),e!==M.zoom){e=Math.min(e,K()),e=Math.max(e,J());var t=ae(0,null,null),i=ae(0,null,null,e),a=(x.scroller.scrollLeft()-t.width)/M.zoom*e,r=(x.scroller.scrollTop()-t.height)/M.zoom*e;M.zoom=e,ot(!0,function(){var t=this;Nt(this,o),tt(e,!0,function(){var e=this;Nt(this,t),Ke(),me(i.width+a,i.height+r,!1,k,function(){Nt(this,e),x.scrollH&&x.scrollH.scrollLeft(x.scroller.scrollLeft()),x.scrollV&&x.scrollV.scrollTop(x.scroller.scrollTop()),null!=n&&n()}.bind(this))}.bind(this))}.bind(this))}else Ke(),"function"==typeof n&&n.call()}function Ke(){S.zooming=!1,Xe(),jt({type:"zoomchanged",zoom:M.zoom})}function $e(e,t){Je(M.zoom+(e?-1:1)*M.zoom*.3,t)}function et(){x.edges[0]._z=M.zoom}function tt(e,t,n){if(0<x.edges.length){n="function"==typeof n?un([et,n]):et;var o=M.direction===en.Vertical,i=ae(0,null,null,e),a=o?i.height:i.width;if(t&&!S.loading){var r=o?{height:a}:{width:a};x.edges[0].animate(r,{duration:k,easing:"easeOutQuad",complete:n,queue:!1})}else o?x.edges[0].height(a):x.edges[0].width(a),"function"==typeof n&&n.call();nt()}}function nt(c){setTimeout(function(){var e=Qt("<canvas/>");c=c||M.zoom;var t=M.direction===en.Vertical,n=S.newpagedivsize?S.newpagedivsize:{width:E.size.width*c,height:E.size.height*c},o=Math.max(1,M.pagespacing);e[0].width=1*(n.width+o),e[0].height=1*n.height;var i=e[0].getContext("2d");i.lineWidth=M.pageborderwidth,M.backcolor&&(i.fillStyle=M.backcolor);for(var a=0;a<1;++a){var r=t?1+a*n.width:1,l=t?1:1+a*n.height;i.strokeRect(r,l,n.width-2,n.height-2),M.backcolor&&i.fillRect(r+i.lineWidth,l+i.lineWidth,n.width-2*(1+i.lineWidth),n.height-2*(1+i.lineWidth))}var s={backgroundImage:"url("+e[0].toDataURL()+")",backgroundSize:"auto auto",backgroundRepeat:t?"repeat-y":"repeat-x"};x.edges[0].css(s),x.edges[1].css(s)},0)}function ot(e,t){for(var n=0,o=!0,i=function(){if(--n<=0){if(M.direction===en.Horizontal){var e=ie().width;x.spacer||(x.spacer=A(),x.spacer.css({position:"absolute",top:"-1px",height:"1px"}),x.viewport.append(x.spacer)),x.spacer.width(e)}"function"==typeof t&&t.call(),0===S.prpr&&(Kt.Safari||Kt.Chrome)&&x.edges[1].hide().show()}},a=0;a<x.pageDivs.length;a++){if(x.pageDivs[a]._img)(x.pageDivs[a]._img.needsZoom()||x.pageDivs[a]._img.needsRotate())&&(o=!1,n++,x.pageDivs[a]._img.needsRotate()?x.pageDivs[a]._img.rotate(i):x.pageDivs[a]._img.needsZoom()&&x.pageDivs[a]._img.zoom(e,i))}o&&i.call()}
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function fit
   */function it(e,t,n){null!=t?"function"==typeof t&&(n=t,t=E.number):t=E.number;var o=at(e,t-1),i=o.zoom,a=tn.Width===o.fit&&en.Vertical===M.direction,r=tn.Height===o.height;a&&me(0,null,!1),r&&me(null,0,!1),Je(i,n)}function at(e,t){var n,o,i=(n=ue(),o=M.showpageborder?2*M.pageborderwidth:0,{width:n.width-o,height:n.height-o}),a=ee(t,1,!1);0!==a.width&&0!==a.height||(e=null);var r=M.zoom;switch(e){case tn.None:break;case tn.Best:e=a.width/i.width>a.height/i.height?(r=i.width/a.width,tn.Width):(r=i.height/a.height,tn.Height);break;case tn.Height:r=i.height/a.height;break;case tn.Width:r=i.width/a.width;break;default:r=1,e=tn.None}return{zoom:r,fit:e}}function rt(e){return M.zoom*C.document.getPageFitMultiplier(e)}function lt(e){return C.document.getPageRotation(e)}function st(e,t){t=t||0;var n=lt(e),o=rt(e),i=se(e,t),a=Jt.matrix();a.scale(o,o,0,0),a.rotate(n+t,0,0);var r,l,s=(r=a,l={x:i.width,y:i.height},{x:r.x(l.x,l.y),y:r.y(l.x,l.y)}),c=Math.min(0,s.x),u=Math.min(0,s.y),d=a.invert(),h=d.x(-c,-u),f=d.y(-c,-u);return a.translate(h,f),a}function ct(e){var t=Qt.data(e.currentTarget,"_config"),n=Qt.data(e.currentTarget,"_annoConfig");!n&&t&&(n={type:t.icon,rotatable:M.showrotatetools}),n&&(C.mouseTool.setTool($t.None,$t.None),C.annotations.drawAnnotation(n,!1,dt,ut))}function ut(){C.mouseTool.setTool($t.Pan,$t.None)}function dt(){C.mouseTool.setTool($t.Pan,$t.None)}
/**
   * Checks whether annotations support is enabled.
   * @private
   */function ht(){return!1===M.allowannotations&&F("InitError",'The "allowannotations" property in the WebDocumentViewer config is set to false.'),M.allowannotations}function ft(){for(var e=0;e<x.pageDivs.length;e++)x.pageDivs[e]._draw.toFront()}function pt(){for(var e=0;e<x.pageDivs.length;e++)x.pageDivs[e]._draw.reset()}function gt(e,t,n){if(e){if(S.loading=!0,Me(),E.size.width=e.pagewidth,E.size.height=e.pageheight,E.count=e.pagecount,E.buffer=M.pagebuffersize,E.dpi=e.dpi,E.vector=!0===e.vector,M.allowannotations=n.allowannotations,M.allowforms=n.allowforms,M.allowtext=n.allowtext,M.documenturl=n.documenturl,M.annotationsurl=n.annotationsurl,M.formsurl=n.formsurl,C.document.__linkChanges(t),C.annotations&&(C.annotations.clear(),C.annotations.loadAnnotations(e)),C.forms&&(C.forms.clear(),e.forms&&C.forms.loadForms(e)),C.text&&C.text.search(""),S.zooming=!1,e.zoom)M.zoom=e.zoom;else{var o=at(M.fitting,1);M.zoom=o.zoom}xt(e.pagenumber||0),C.mouseTool.setTool(M.mousetool.type?M.mousetool.type:$t.Pan,$t.None),nt(),S.loading=!1,ot(),N=t.__getSelectedPagesIndices,jt({type:"activedocumentchanged"})}}function mt(e,t){t&&Ft(!0);for(var n=0;n<e._controllers.document.getPageCount();++n){var o=e._controllers.document.getPageDefinition(n,s);o&&0<=o.cacheIndex&&x.loadedImgs[o.cacheIndex]&&(C.memory.deallocate(x.loadedImgs[o.cacheIndex]),x.loadedImgs[o.cacheIndex].dispose(),x.loadedImgs[o.cacheIndex].remove(),x.loadedImgs[o.cacheIndex]=void 0)}}function vt(e,o){S.loading=!0;var t={atala_docurl:M.documenturl,atala_pagebuffer:M.pagebuffersize,atala_minwidth:M.minwidth};null!=e&&("function"==typeof e&&(o=e,e=null),Qt.extend(t,e)),St({type:"docinfo",serverurl:M.serverurl,query:"?ataladocinfo=",method:"GET",data:t,cancel:!1,info:{pagewidth:-1,pageheight:-1,pagecount:-1}},function(e){bt(e,o)},function(e,t,n){!function(e,t,n,o){if(e.responseText){var i=e.responseText.substr(e.responseText.indexOf("</html>")+7);0<=i.indexOf("\x3c!--")?0<(i=i.replace("\x3c!--","").replace("--\x3e","")).length&&(n="<pre>"+i+"</pre>"):0<e.responseText.indexOf("web.config")&&0<e.responseText.indexOf("customErrors")&&(n+=": web.config customErrors attribute has disabled remote error messages.")}F("DocumentLoadError",n),"function"==typeof o&&o.call(void 0,n)}(e,0,n,o)})}function bt(t,n){var e,o;t&&!1!==t.licensed?(E.size.width=t.pagewidth,E.size.height=t.pageheight,E.count=t.pagecount,E.buffer=M.pagebuffersize,E.dpi=t.dpi,E.vector=!0===t.vector,E.caption=t.thumbcaptionformat||(M.showthumbcaption?"{0}":""),oe.zero(),C.memory.clearEntries(),C.memory.colorDepth=t.colordepth,C.memory.pageSize={width:t.pagewidth,height:t.pageheight},jt({type:"documentinfochanged",info:{count:E.count,dpi:E.dpi,size:{height:E.size.height,width:E.size.width},vector:E.vector},customData:t.customData}),C.text&&(C.text.clear(),t.text&&C.text.loadText(t)),S.loading&&(M.zoom=1,U(),me(0,0),x.scrollV&&x.scrollV.pageNum(1),Se(1),it(M.fitting,1,function(){we(),ze(0,x.pageDivs.length-1);for(var e=0;e<x.pageDivs.length&&e<E.count;e++)Ie(x.pageDivs[e],null,e);x.content.append(x.pageDivs[0]),0<x.pageDivs.length&&x.pageDivs[0].addClass(an.atala_active_page),t.layers&&t.layers.length?C.annotations.loadAnnotations(t):M.annotationsurl&&C.annotations&&C.annotations.clear(),C.forms&&(C.forms.clear(),t.forms&&C.forms.loadForms(t)),C.mouseTool.setTool(M.mousetool.type?M.mousetool.type:$t.Pan,$t.None),S.loading=!1,nt(),"function"==typeof n&&n(t.error,t),t.error&&setTimeout(function(){F("DocumentLoadError",t.error)},0)})),S.loading=!1):(o=t&&!1===t.licensed?(e="LicenseException",t.error?t.error:"LicenseException: Handler was unable to find a valid license."):(e="DocumentLoadError","HandlerException: Handler did not return any data."),S.loading=!1,"function"==typeof n&&n.call(void 0,o),e&&o&&F(e,o))}function yt(){xt()}function xt(e){if(U(),0<x.pageDivs.length){var t=C.document.getPageCount(),n="number"==typeof e?e:x.pageDivs[0]._index;n=0<=n?Math.min(n,t-x.pageDivs.length):0;for(var o=0;o<x.pageDivs.length&&o<t;o++){var i=n+o;Fe(x.pageDivs[o]),Ie(x.pageDivs[o],null,i)}x.content.append(x.pageDivs[0])}ze(0<x.pageDivs.length&&x.pageDivs[0]._index,null),we(),Dt(),ve(),Se((0<x.pageDivs.length?x.pageDivs[0]._index:0)+1)}function _t(e,t){var n={atala_docurl:M.documenturl,atala_spath:M.savepath};function o(e){!function(e){e.error?F("DocumentSaveError",e.error):fe("DocumentSave: success="+e.success);jt({type:"documentsaved",success:e.success,customData:e.customData,fileName:e.fileName})}(e),"function"==typeof t&&t.call()}Qt.extend(n,e),St({type:"docsave",serverurl:M.serverurl,query:"?ataladocsave=",method:"POST",data:n,cancel:!1,info:{success:void 0,error:void 0}},o,function(e){var t=[];t.error=e.responseText,o(t)})}function wt(e,t,n){var o=null;return"string"==typeof e?(o={},S.initialized&&n&&(0<e.length?o=n.createHandlerRequest(M.serverurl,e,t):0===e.length&&n.clear()),o.url=e):void 0!==e&&null!=e&&F("openUrlError","string input expected for url."),o}function zt(){Bt({annotationsloaded:Ct})}function Pt(){Bt({formsloaded:Et})}function Dt(e){if(!(0<x.pageDivs.length&&void 0===x.pageDivs[0]._index))for(var t=0;t<x.pageDivs.length;t++)kt(x.pageDivs[t],e)}function Tt(e,t){var n=je(e);n&&kt(n,t)}function kt(e,t){(Ie(e,Be(e._index),e._index)||t)&&(C.annotations&&C.annotations.showLayer(e._index,e),C.forms&&C.forms.showLayer(e._index,e),C.text&&M.allowtext&&C.text.showLayer(e._index,e))}function Ct(e){e.error&&(F("AnnotationsLoadError",e.error),M.annotationsurl=""),C.annotations&&Rt({annotationsloaded:Ct})}function Et(e){e.error&&(F("FormsLoadError",e.error),M.formsurl=""),C.forms&&Rt({formsloaded:Et})}function St(o,t,i,n){var a,r,e,l=this,s=(a=o,r=function(e){t(e.request.info)},Bt({handlerreturned:e=function e(t){t.request===a&&(Rt({handlerreturned:e}),"function"==typeof r&&r.call(this,t))}}),e);if(jt({type:"beforehandlerrequest",request:o}),!o.cancel&&(Rt({handlerreturned:s}),o.serverurl&&!Qt.isEmptyObject(o.data))){if(!(o.info instanceof Qt&&"docpage"===o.type)){if("fileupload"!==o.type)return Qt.ajax({type:o.method,url:o.serverurl+o.query+"?",dataType:"json",data:o.data,success:t,error:i,crossDomain:("string"!=typeof o.method||"post"!==o.method.toLowerCase())&&void 0});var c="&"+Qt.param(o.data),u=new FormData;u.append("file",o.file,o.file.name);var d=Qt.ajax({type:o.method,url:o.serverurl+o.query+"??"+c,dataType:"json",data:u,contentType:!1,processData:!1,success:function(e){Nt(this,l),e.success&&(e.success=JSON.parse(e.success)),e.canceled&&(e.canceled=JSON.parse(e.canceled)),t(e,o.file.name)}.bind(this),error:function(e,t,n){Nt(this,l),i(t,n,o.file.name)}.bind(this),crossDomain:("string"!=typeof o.method||"post"!==o.method.toLowerCase())&&void 0,xhr:function(){var t=this;Nt(this,l);var e=new XMLHttpRequest;return e.upload.addEventListener("progress",function(e){Nt(this,t),e.lengthComputable&&(n(o.file.name,e.loaded,e.total)||d.abort())}.bind(this),!1),e}.bind(this)});return d}o.info.attr("src",o.serverurl+o.query+"&"+Qt.param(o.data))}}
/**
   ...
   * @function empty
   */
function Mt(e){S.loading=!0;Ft(),bt({pagewidth:0,pageheight:0,pagecount:-1},function(){ve(),jt({type:"documentunloaded"}),"function"==typeof e&&e.call()})}function Ft(e){var t;S.initialized&&(Me(),U(0),e||function(){for(var e=0;e<x.loadedImgs.length;e++)x.loadedImgs[e]&&(x.loadedImgs[e].dispose(),x.loadedImgs[e].remove());x.loadedImgs.length=0}(),x.edges[0].width(0).height(0),x.edges[1].width(0).height(0),x.scrollH&&(x.scrollH.scrollSize(0),ye(x.scrollH)),x.scrollV&&(x.scrollV.scrollSize(0),ye(x.scrollV)),t={backgroundImage:"",backgroundSize:"",backgroundRepeat:"",backgroundColor:""},x.edges[0].css(t),x.edges[1].css(t))}
/**
...
/**
   ...
   * @returns {boolean}
   */
function At(){return S.initialized}
/**
...
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function openUrl
   */function Vt(e,t,n,o){null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null));var i=0,a=!1,r=wt(t,e,C.annotations),l=wt(n||e,e,C.forms);M.annotationsurl=r?r.url:M.annotationsurl,M.formsurl=l?l.url:M.formsurl;var s,c,u,d,h=function(e,t){--i<=0&&(Dt(!0),jt({type:"documentloaded",customData:null==t?void 0:t.customData}),"function"==typeof o&&o.call(void 0,e,t))};if("string"==typeof e){if(0===e.length)Mt(h);else if(M.documenturl=e,S.initialized){Ft(),X(x.scrollH),X(x.scrollV),i++,0===e.length&&Mt(h);var f={};M.allowannotations&&r&&r.data&&(zt(),Qt.extend(f,r.data)),M.allowforms&&l&&l.data&&(Pt(),Qt.extend(f,l.data)),a=!0,vt(f,h)}}else!(e||!(0<M.documenturl.length)||!t&&""!==t&&!n&&""!==n)||F("openUrlError","string input expected for document url.");a||(r&&(i++,u=r,d=h,C.annotations&&(zt(),C.annotations.makeHandlerRequest(u,d))),l&&(i++,s=l,c=h,C.forms&&(Pt(),C.forms.makeHandlerRequest(s,c))))}
/**
...
/**
   ...
   * @returns debug info object if available, otherwise null
   */
return c.__getDebugInfo=function(){var e={version:mn.join(".")};M.debug&&Qt.extend(!0,e,{dom:x,controllers:C,page:E});return e}
/**
...
/**
   ...
   * @function dispose
   */
function(){if(r&&r.closeDocument(),Ft(),x.main&&x.main.remove(),x.toolbar&&(x.toolbar.controlgroup("destroy"),x.toolbar.remove(),x.toolbar.annoToolbar&&(x.toolbar.annoToolbar.controlgroup("destroy"),x.toolbar.annoToolbar.remove())),x.search&&x.search.dispose(),x.uploadCtrl&&x.uploadCtrl.remove(),x.main=null,x.toolbar=null,x.scroller=null,x.viewport=null,x.content=null,x.scrollH=null,x.scrollV=null,x.loadedImgs.length=0,x.pageDivs.length=0,x.pageLabel=null,x.status=null,x.search=null,x.uploadCtrl=null,x.edges){for(var e=0;e<x.edges.length;e++)x.edges[e]=null;x.edges=[]}for(var t in C)C.hasOwnProperty(t)&&null!==C[t]&&(C[t].dispose(),C[t]=null);S={prpr:0,batchoperation:0,loading:(E={size:{width:0,height:0},sizes:[{width:0,height:0}],smallest:{width:0,height:0},count:0,number:-1,numberoutof:-1,buffer:3,dpi:96,vector:!1,caption:"",customData:null},!1),zooming:!1,initialized:!1,newpagedivsize:null,newpagedivfullzoom:1,scrollPos:{x:0,y:0,t:0},scrollBuffer:null,scrollTimeout:null,activepage:null,nextImageCacheIndex:0}},c.empty=Mt,c.fit=it,c.getZoom=function(){return M.zoom},c.isReady=At,c.scrollTo=function(e,t,n,o){null==o&&"function"==typeof n&&(o=n,n=!1);me(e,t,n,null,o)}
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function scrollBy
   */,c.scrollBy=function(e,t,n,o){null==o&&"function"==typeof n&&(o=n,n=!1);i=e,a=t,r=n,l=null,s=o,me(x.scroller.scrollLeft()+i,x.scroller.scrollTop()+a,r,l,s);var i,a,r,l,s},c.next=Te,c.previous=De,c.zoom=Je,c.zoomIn=It,c.zoomOut=Ot,c.openUrl=c.OpenUrl=Vt,c.save=Ht,c.uploadFiles=
/**
...
/**
   ...
   */,c.reloadPage=function(o,e,t,n,i){var a=Qt.Deferred(),r=Qt.Deferred(),l=Qt.Deferred(),s=Qt.Deferred();"function"==typeof n&&(i=n,n=void 0),"function"==typeof t&&(i=t,t=!1),"function"==typeof e&&(i=e,e=!1),"function"==typeof i&&a.done(i);var c=C.document.getPageDefinition(o);if(!c)return a.resolve(),a.promise();0<=c.cacheIndex&&x.loadedImgs[c.cacheIndex]?s=Le(c,n):Be(o,n,function(){s.resolve()});var u="string"==typeof e?e:c.uri?null:M.annotationsurl;M.allowannotations&&e&&(u||c.uri)?C.annotations.loadAnnotationsUrl(M.serverurl,u,c.uri,c.index,1,o,function(){r.resolve(!0)}):(e&&C.annotations.loadAnnotations({layers:[[]],offset:o}),r.resolve(!!e));var d="string"==typeof t?t:c.uri?null:M.formsurl;return M.allowforms&&t&&(M.formsurl||d)?C.forms.loadFormUrl(M.serverurl,d,c.uri,c.index,1,o,function(){l.resolve(!0)}):l.resolve(),Qt.when(s,r,l).done(function(e,t,n){(t||n)&&Tt(o,!0),a.resolve(o)}),a.promise()},c.showPage=ke,c.showPageNumber=Ce,bn(),_n(),yn(),wn(),c.annotations=bn.__exposedApi,c.document=_n.__exposedApi,c.forms=yn.__exposedApi,c.text=wn.__exposedApi,function(){At()||(S={prpr:0,batchoperation:0,loading:(E={size:{width:0,height:0},sizes:[{width:0,height:0}],smallest:{width:0,height:0},count:0,number:-1,numberoutof:-1,buffer:3,dpi:96,vector:!1,caption:"",customData:null},!1),zooming:!1,initialized:!1,newpagedivsize:null,newpagedivfullzoom:1,scrollPos:{x:0,y:0,t:0},scrollBuffer:null,scrollTimeout:null,activepage:null,nextImageCacheIndex:0});var e={_config:M,_id:s,_dom:x,_document:x.loadedImgs,_pages:x.pageDivs,_state:S,_internalEvents:a,_controllers:C,createDOM:w,createDiv:A,createDialog:T,createDropDownButton:I,createDropDownMenu:O,createMenu:D,drawAnnotation:ct,redrawVisiblePages:Dt,adjustVisiblePages:ot,startDomManipulation:Ze,endDomManipulation:Xe,redrawPageFromIndex:Tt,makeHandlerRequest:St,getPageScale:rt,getPageSize:ce,getSourcePageSize:se,getPageRotation:lt,getViewerTransform:st,isPageInView:Re,findPageFromIndex:je,showPagePoint:Ne};C.document=new _n(c,e,s),c.document=C.document.__exposedApi,M.allowannotations?(C.annotations=new bn(c,e,!1),c.annotations=C.annotations.__exposedApi):(c.deselectAll=ht,c.createAnnotationOnPage=ht,c.getAnnotationsFromPage=ht,c.deleteAnnotationOnPageAtIndex=ht,c.setAnnotationDefaults=ht,c.setImages=ht,c.setStamps=ht),M.allowforms&&!C.forms&&(C.forms=new yn(c,e),c.forms=C.forms.__exposedApi),M.allowtext&&(C.text=new wn(c,e,M.mousetool?M.mousetool.text:{}),c.text=C.text.__exposedApi),C.upload=new xn(c,e),!1===S.initialized&&(S.initialized=!0,Bt({throwerror:_,pagedivsresized:f,documentchanged:yt,pagesizechanged:p}),M.parent?(M.parent instanceof Qt||(M.parent=Qt(M.parent)),M.parent.length||F("InitError","Parent element not found.")):F("InitError","No parent element given."),x.toolbar=(t=M.toolbarparent||M.parent,(n=function(e){var t=this,n={id:s+"_toolbar",parent:e,children:[{type:"button",id:"Button_PagePrev",cls:an.atala_tool_button_page_prev,icon:"page-prev",tooltip:"Previous Page",text:null,onclick:function(){De()}},{type:"pagelabel",id:"Label_PageNumber",cls:an.atala_page_label},{type:"button",id:"Button_PageNext",cls:an.atala_tool_button_page_next,icon:"page-next",tooltip:"Next Page",text:null,onclick:function(){Te()}},{type:"button",id:"Button_ZoomOut",cls:an.atala_tool_button_zoom_out,icon:"zoom-out",tooltip:"Zoom Out",text:"",onclick:function(){Ot()}},{type:"button",id:"Button_ZoomIn",cls:an.atala_tool_button_zoom_in,icon:"zoom-in",tooltip:"Zoom In",text:"",onclick:function(){It()}},{type:"button",id:"Button_FitNone",cls:an.atala_tool_button_fit_none,icon:"zoom-full",tooltip:"Full Size",text:"",onclick:function(){Je(1)}},{type:"button",id:"Button_FitBest",cls:an.atala_tool_button_fit_best,icon:"fit-best",tooltip:"Best Fit",text:"",onclick:function(){it(tn.Best)}},{type:"button",id:"Button_FitWidth",cls:an.atala_tool_button_fit_width,icon:"fit-width",tooltip:"Fit To Width",text:"",onclick:function(){it(tn.Width)}}]};return M.showselecttools&&n.children.splice(5,0,{type:"button",id:"Button_ZoomArea",cls:an.atala_tool_button_zoom_area,icon:"zoom-area",tooltip:"Zoom Area",text:"",onclick:R}),M.allowtext&&(n.children.splice(3,0,{type:"button",id:"Button_Text",cls:an.atala_tool_button_text_tool,icon:"text-tool",tooltip:"Text Selection",text:"",onclick:function(){C.mouseTool.setTool($t.Text)}}),n.children.splice(3,0,{type:"button",id:"Button_Text",cls:an.atala_tool_button_pan_tool,icon:"pan-tool",tooltip:"Pan",text:"",onclick:function(){C.mouseTool.setTool($t.Pan)}})),M.showrotatetools&&(n.children.push({type:"button",id:"Button_RotateLeft",cls:an.atala_tool_button_rotate_left,icon:"rotate-left",tooltip:"Rotate Left",text:"",onclick:j(270)}),n.children.push({type:"button",id:"Button_RotateRight",cls:an.atala_tool_button_rotate_right,icon:"rotate-right",tooltip:"Rotate Right",text:"",onclick:j(90)})),0<M.savepath.length&&n.children.unshift({type:"button",id:"Button_Save",cls:an.atala_tool_button_save,icon:"save",tooltip:"Save Changes",text:null,onclick:function(){Ht()}}),!1!==M.upload.enabled&&n.children.unshift({type:"button",id:"Button_Upload",cls:an.atala_tool_button_upload,icon:"upload",tooltip:"Upload document",text:null,onclick:function(){!function(){var t=this;C.upload.uploadWithUi(function(e){Nt(this,t),e?(x.toolbar.controlgroup("enable"),M.allowannotations&&x.toolbar.annoToolbar.controlgroup("enable"),x.toolbar.find(".atala_page_label, .atala_search_container").removeClass("ui-state-disabled")):(x.toolbar.controlgroup("disable"),x.toolbar.annoToolbar&&x.toolbar.annoToolbar.controlgroup("disable"),x.toolbar.find(".atala_page_label, .atala_search_container").addClass("ui-state-disabled"))}.bind(this))}()}}),M.toolbarbuttons&&M.toolbarbuttons.reverse().forEach(function(e){Nt(this,t),n.children.unshift({type:"button",id:e.id,cls:e.class,tooltip:e.tooltip,onclick:e.onclick,text:null,icon:e.icon,custom:!0})}.bind(this)),P(n)}(t)).controlgroup(),M.allowannotations&&(n.annoToolbar=P({id:s+"_toolbar",parent:t,children:[{type:"button",id:"Button_Ellipse",cls:an.atala_tool_button_ellipse_anno,icon:"ellipse",tooltip:"Draw Ellipse",text:"",onclick:ct},{type:"button",id:"Button_Highlight",cls:an.atala_tool_button_highlight_anno,icon:"highlight",tooltip:"Draw Highlight",text:"",onclick:ct},{type:"button",id:"Button_Line",cls:an.atala_tool_button_line_anno,icon:"line",tooltip:"Draw Line",text:"",onclick:ct},{type:"button",id:"Button_Lines",cls:an.atala_tool_button_lines_anno,icon:"lines",tooltip:"Draw Poly Lines",text:"",onclick:ct},{type:"button",id:"Button_Freehand",cls:an.atala_tool_button_freehand_anno,icon:"freehand",tooltip:"Draw Freehand",text:"",onclick:ct},{type:"button",id:"Button_Polygon",cls:an.atala_tool_button_polygon_anno,icon:"polygon",tooltip:"Draw Polygon",text:"",onclick:ct},{type:"button",id:"Button_Rectangle",cls:an.atala_tool_button_rect_anno,icon:"rectangle",tooltip:"Draw Rectangle",text:"",onclick:ct},{type:"button",id:"Button_Text",cls:an.atala_tool_button_text_anno,icon:"text",tooltip:"Draw Text",text:"",onclick:ct}]}),n.annoToolbar.addClass(an.atala_annotation_toolbar),n.annoToolbar.controlgroup()),M.showstatus&&(x.status=Qt('<div id="'+s+'_status" style="display:inline"></div>'),x.status.addClass(an.atala_statusbar),n.append("Status:"),n.append(x.status)),M.allowtext&&M.mousetool.text.allowsearch&&(x.search=new B({parent:n})),n),x.toolbar.addClass(an.atala_toolbar),x.main=A(M.parent),x.main.addClass(an.atala_main_container),x.scroller=A(x.main),x.scroller.addClass(an.atala_scroller),x.main.on({selectstart:v}),x.toolbar.attr("id",s+"_toolbar"),x.main.attr("id",s+"_main"),x.scroller.attr("id",s+"_scroller"),x.main.css({height:"100%",width:"100%",position:"relative"}),x.scroller.css({height:"100%",width:"100%",position:"relative"}),x.viewport=A(x.scroller,s+"_vp"),x.viewport.css({overflow:"hidden",fontSize:0,"touch-action":"none"}),x.viewport.addClass(an.atala_viewport),x.viewport.attr("tabindex",-1),x.edges[0]=q(x.viewport,s+"_e0"),x.edges[0].addClass(an.atala_dom_edge_first),x.content=A(x.viewport,s+"_ct"),x.content.addClass(an.atala_content),x.content.css({"-ms-touch-action":"none",fontSize:0,overflow:"hidden"}),M.direction===en.Horizontal&&x.content.css({display:"inline-block"}),x.edges[1]=q(x.viewport,s+"_e1"),x.edges[1].addClass(an.atala_dom_edge_last),Kt.Features.Compatibility&&F("InitError","Compatibility Mode is not supported."),!1!==M.upload.enabled&&(x.uploadCtrl=C.upload.getUploadControl()),Kt.Mobile.Any()?x.scroller.css({overflow:"hidden"}):M.showscrollbars?(x.scroller.css({overflow:"scroll"}),x.scrollH=Z(x.main,en.Horizontal),x.scrollH.attr("id",s+"_sH"),x.scrollH.addClass(an.atala_scroll_horizontal),x.scrollV=Z(x.main,en.Vertical),x.scrollV.attr("id",s+"_sV"),x.scrollV.addClass(an.atala_scroll_vertical)):x.scroller.css({overflow:"hidden"}),C.mouseTool=new zn(c,{_internalEvents:a,_controllers:C,zoomStart:Ge,zoom:Ye,zoomEnd:Qe,getActivePage:Pe,raiseDrawLayer:ft,resetDrawLayer:pt,getViewerTransform:st},x.viewport,x.scroller,Qt.extend({allowflick:M.allowflick},M.mousetool)),C.memory=new gn({highWaterMark:M.memorythreshold}),C.memory.bind({exceededhighwatermark:h}),C.annotations&&C.annotations.setViewPort(x.viewport),jt("initialized"),M.direction===en.Horizontal&&x.viewport.css({"white-space":"nowrap"}),x.viewport.css({display:"table-cell"}),G(x.scroller),x.scrollH&&x.edges[1].height(x.scrollH.scrollbarHeight()),C.mouseTool.setTool($t.Pan,$t.None),(M.documenturl||M.annotationsurl||M.formurl)&&Vt(M.documenturl,M.annotationsurl,M.formurl,o),Qt(m));var t,n}(),c}function Dn(e,t){if(e!==t)throw new TypeError("Cannot instantiate an arrow function")}
/**
 * Control that views, modifies, and saves documents, annotations and forms.
 * @param {WebDocumentViewerConfig} [settings] Object of key value pairs representing initial settings
 * @param {OpenUrlCallback} [openCallback] callback that is called when document load complete(if {@link WebDocumentViewerConfig.documenturl| documenturl} is specified).
 ...
 * @returns {WebDocumentViewer} A new control with the given settings.
 * @memberof Atalasoft.Controls
 */var Ke=function(e,o){if(!ln())return null;var t,c={typeOf:e.type||"Atalasoft.Controls.WebDocumentViewer"},k="Atalasoft.Controls.WebDocumentThumbnailer"===c.typeOf,s="",C=150,u=500,y="atala-ui-icon",n=document.createElement("div"),i=Qt({}),a=Qt({}),r=new pn({get:function(){return c},isInitialized:Bt,switchDocument:_t,closeDocument:wt}),x={
/** Main outer object that holds the scrollbars */
main:null,
/** Toolbar wrapper object */
toolbar:null,
...
status:null,
/** Upload control*/
uploadCtrl:null},E={annotations:null,document:null,forms:null,mouseTool:null,memory:null,text:null,upload:null},S={size:{width:0,height:0},sizes:[{width:0,height:0}],smallest:{width:0,height:0},count:0,number:-1,numberoutof:-1,buffer:3,dpi:96,vector:!1,caption:"",customData:null},M={prpr:0,batchoperation:0,loading:!1,zooming:!1,initialized:!1,newpagedivsize:null,newpagedivfullzoom:1,scrollPos:{x:0,y:0,t:0},scrollBuffer:null,scrollTimeout:null,activepage:null,nextImageCacheIndex:0,scrollTargetPage:0,hidden:!1},d={
/**
     * @typedef {Object} Request
     * @property {string} method - The request HTTP method.
     * @property {Object} data - The request parameters that will be send to server.
...
/**
    ...
    *   **Default value**: {} - which selects the default American English localization.
    */
localization:cn};if(e){var l=e.mousetool;e.mousetool&&"object"!=typeof e.mousetool&&(e.mousetool=Qt.extend({},F.mousetool,{type:l})),!e.tabular||e.direction!==en.Horizontal&&1!==e.columns||(e.tabular=!1),Qt.extend(!0,F,e),e.mousetool=l,e.localization&&vn.SetLocalizationStrings(e.localization)}if(F.direction=F.direction===en.Vertical||F.direction===en.Horizontal?F.direction:en.Vertical,F.fitting=F.fitting===tn.None||F.fitting===tn.Best||F.fitting===tn.Width||F.fitting===tn.Height?F.fitting:tn.Width,F.pageborderwidth=ye(F.pageborderwidth)?parseInt(F.pageborderwidth,10):1,F.pagespacing=ye(F.pagespacing)?parseInt(F.pagespacing,10):4,F.showpageborder=!!F.showpageborder,F.showpagenumber=!!F.showpagenumber,F.showstatus=!!F.showstatus,F.zoom=ye(F.zoom,!0)?parseFloat(F.zoom):1,F.scripturl=0<(t=F.scripturl).length&&-1===t.indexOf("/",t.length-1)&&-1===t.indexOf("\\",t.length-1)?F.scripturl+"/":F.scripturl,function(){if((F.mousetool.type===$t.ZoomArea||F.mousetool.type===$t.Selection||F.mousetool.type===$t.Text)&&!F.showselecttools){if(null!==e.showselecttools&&void 0!==e.showselecttools)throw"The mouse tool type is incompatible with 'showselecttools' flag value.Please change the tool type or enable selection tools.";F.showselecttools=!0}}(),function(){F.upload||(F.upload={enabled:!1});var e=F.upload;!1!==e.enabled&&(e.allowedmaxfilesize=hn(e.allowedmaxfilesize)?e.allowedmaxfilesize:Number.MAX_VALUE,e.allowdragdrop=!!e.allowdragdrop,e.allowmultiplefiles=!!e.allowmultiplefiles,e.allowedfiletypes="string"==typeof e.allowedfiletypes?e.allowedfiletypes:"",e.uploadpath="string"==typeof e.uploadpath?e.uploadpath:".",e.filesuploadconcurrency=hn(e.filesuploadconcurrency)?e.filesuploadconcurrency:1,e.closeuiafterupload=!1!==e.closeuiafterupload)}(),!sn(F.allowannotations,F.allowtext))return null;function h(){var e=E.memory.deallocateOldestEntry();!function(e){try{e.parentNode&&e.parentNode.removeChild(e),n.appendChild(e),n.innerHTML=""}catch(e){}}(e[0]),0<=e._cacheIndex&&(x.loadedImgs[e._cacheIndex]=null,e._cacheIndex=-1),e.remove(),e.length=0,e=null}function f(e){M.newpagedivsize={height:e.height,width:e.width},M.newpagedivfullzoom=e.fullzoom,F.minwidth=e.minwidth,F.zoom=e.fullzoom,Dt()}function p(e){var t=!1;if((S.smallest.width<=0||e.width<S.smallest.width)&&(S.smallest.width=e.width,t=!0),(S.smallest.height<=0||e.height<S.smallest.height)&&(S.smallest.height=e.height,t=!0),!k){var n=M.scrollTargetPage-1;if(e.index<=n)if(F.direction===en.Vertical){var o=le(x.pageDivs[0]._index).height;x.edges[0].height(o),Ce(x.pageDivs[0]._index,null),xe(null,le(n).height,!1)}else if(F.direction===en.Horizontal&&1<Math.abs(e.dx)){var i=le(x.pageDivs[0]._index).width;x.edges[0].width(i),Ce(x.pageDivs[0]._index,null),ke(),xe(le(n).width,null,!1)}!function(e,t){if(F.direction===en.Vertical){if(x.scrollV)if(x.scrollV.scrollSize(Math.max(x.scrollV._scrollSize+t,0)),1===x.scrollV._ratio&&x.scrollV._scrollSize+t<3e4)x.scrollV._tray.height(x.scrollV._tray.height()+t),x.scrollV._max=Math.max(x.scrollV._tray.height()-x.scrollV[0].clientHeight,0)+1;else{var n=x.scrollV.height()-x.scrollH.scrollbarHeight()-1,o=(3e4-n)*x.scrollV._ratio;3e4<o+t?x.scrollV.ratio((o+t)/(3e4-n)):we()}Pe(x.scrollV),ze(x.scrollH,"width")}else if(F.direction===en.Horizontal){if(x.scrollH)if(x.scrollH.scrollSize(Math.max(x.scrollH._scrollSize+e,0)),1===x.scrollH._ratio&&x.scrollH._scrollSize+e<3e4)x.scrollH._tray.width(x.scrollH._tray.width()+e),x.scrollH._max=Math.max(x.scrollH._tray.width()-x.scrollH[0].clientWidth,0)+1,x.scrollH.ratio(x.scrollH._scrollSize/x.scrollH._max);else{var i=x.scrollH.width()-x.scrollV.width()-1,a=(3e4-i)*x.scrollH._ratio;3e4<a+e?x.scrollH.ratio((a+e)/(3e4-i)):we()}Pe(x.scrollH),ze(x.scrollV,"height")}if((0!==e||0!==t)&&0!==t){var r=x.scroller[0].scrollLeft,l=x.scroller[0].scrollTop;Oe(oe(r,l)+1),Yt({type:"scroll",x:r,y:l,dx:0,dy:0})}}(e.dx,e.dy),ae.zero(),re();var a=x.scroller[0].scrollLeft,r=x.scroller[0].scrollTop;if(!x.scroller.propagationPaused()&&x.scrollH&&x.scrollV){var l=Math.round(a/x.scrollH._ratio),s=Math.round(r/x.scrollV._ratio);l!==x.scrollH.scrollLeft()&&(x.scrollH.pauseEventPropagation(!0),x.scrollH.scrollLeft(l)),s!==x.scrollV.scrollTop()&&(x.scrollV.pauseEventPropagation(!0),x.scrollV.scrollTop(s))}t&&Q(K())>x.pageDivs.length&&Dt()}}function g(e,t,n,o){var i=t.getPageSize(e.index,s);if(!i){var a=t.getPageFitMultiplier(e.index,s),r=a,l={width:e.width,height:e.height};1===r&&F.forcepagefit&&(l.width!==n.width||l.height!==n.height)&&0<l.width&&0<l.height&&(r=l.width/n.width>l.height/n.height?n.width/l.width:n.height/l.height,t.setPageFitMultiplier(e.index,r,s)),t.setPageSize(e.index,Qt.extend({},l),s),o&&(l.width*=F.zoom*r,l.height*=F.zoom*r,(i=Qt.extend({},S.size)).width*=F.zoom*a,i.height*=F.zoom*a,e.dx=l.width-i.width,e.dy=l.height-i.height,p(e))}}function m(){Kt.Mobile.Any()?window.addEventListener("orientationchange",Je):window.addEventListener("resize",Je),x.scroller.scroll(De),W(S.buffer)}function v(e){var t=e.target||e.srcElement;return("TEXTAREA"===t.nodeName||"INPUT"===t.nodeName||"text"===t.type)&&((!t.attributes.selectable||"false"!==t.attributes.selectable.value)&&void 0)}function b(t,n){return function(e){try{e.currentTarget=n&&0<n.length?n[0]:e.currentTarget,t&&t(e)}catch(e){ve(e.message)}}}function A(e,t){if(F.showerrors)throw void 0===t?e:e+": "+t;ve(e+": "+t),Yt({type:"error",name:e,message:t})}function _(e){A(e.name,e.msg)}function w(e,t,n,o){var i=Qt("<"+e+"></"+e+">");return t&&t.append&&i.appendTo(t),n&&i.attr("id",n),o&&i.html(o),i}function I(e,t,n){return w("div",e,t,n)}function z(e){var t=Qt('<div style="width:100%; height:100%; position:absolute; left: 0px; top: 0px; background: #F00; opacity:0.0;"></div>');return t.toFront=function(){t.css({"z-index":"10"}),t.reflow&&t.reflow()},t.reset=function(){t.css({"z-index":""}),t.reflow&&t.reflow()},e&&e.prepend(t),t}function P(e){var t=I(e.parent),n=s+"_toolbar";t.buttons=[];for(var o=0;e.children&&o<e.children.length;o++){var i=null;switch(e.children[o].type){case"button":if(Kt.Features.Touch&&("lines"===e.children[o].icon||"polygon"===e.children[o].icon))continue;e.children[o].id=n+"_"+e.children[o].id,(i=B(e.children[o],t)).addClass(an.atala_toolbar_button),t.buttons.push(i);break;case"pagelabel":x.pageLabel=w("span",t,n+"_"+e.children[o].id),(i=x.pageLabel).addClass("ui-controlgroup-item")}i&&e.children[o].cls&&i.addClass(e.children[o].cls)}return t}function D(e){var t=Qt("<ul/>");for(var n in t.css({fontSize:"medium"}),t.addClass(an.atala_context_menu),e)if(e.hasOwnProperty(n)){var o=Qt('<li><div href="#"> '+n+" </div></li>");Kt.Features.Touch&&o.on({touchend:e[n]}),o.click(e[n]),o.appendTo(t)}return t.menu(),t}function T(e,t,n){var o=Qt('<div title="'+t+'" />');return n&&o.append(n),o.dialog(),o}function O(e){var t=w("span",x.toolbar.annoToolbar).addClass("ui-controlgroup-item");return B(e,t),L(t,e.id+"_Drop","ui-icon-triangle-1-s","Click To Choose",null,function(){var e=Qt(this).next();if(e.is(":visible"))return e.hide(),!1;var t=e.prev().prev().parent();return e.menu().show().css({position:"absolute",top:0,left:0,"min-width":t.width()+"px","z-index":11}).position({my:"left top",at:"left bottom",of:t}),!1}),t.controlgroup(),x.toolbar.annoToolbar.controlgroup("refresh"),t}function V(e,t,n){for(var o=Qt(e.children().first()),i={},a=0;a<n.length;a++)i[n[a].name]=H(o,t,n[a]);o.menu=D(i),e.append(o.menu),o.menu.hide()}function H(e,t,n){var o=function(){return e.button("option","label","Draw "+n.name),e.data("_annoConfig",n),e.click(t.onclick),e.menu.hide(),e.trigger("click"),!1};return Xt("menuselect"+t.icon+n.name,b(o,e)),o}function L(e,t,n,o,i,a){var r=Qt('<button id="'+t+'" title="'+o+'">'+(i||o)+"</button>");return a&&r.click(a),r.button({icon:n,showLabel:null!=i&&F.showbuttontext}),r.addClass("atala-ui-button"),e&&r.appendTo(e),r}function B(e,t){var n,o="menuclick"+(e.custom?e.id:e.icon),i=L(t,e.id,e.custom?e.icon:y+" "+y+"-"+e.icon,e.tooltip,e.text,(n=o,function(e){e.preventDefault(),Yt(n,arguments)}));return i.data("_config",e),Xt(o,b(e.onclick,i)),i}function R(e){var t,n,o={clearable:"atala_search_input_clearable",onclear:"atala_search_input_clear_hover",inputEmpty:"atala_search_input_empty",loading:"atala_search_input_loading"},i=e.parent||x.toolbar,a=null,r=null;function l(){var e=n.val();return e?n.addClass(o.clearable):n.removeClass(o.clearable),!!(e&&a&&a.isValid()&&e===a.getQuery())||(clearTimeout(r),a=null,e&&3<=e.length?(p(!0),r=setTimeout(function(){a=E.text.search(e,Zt(),h),f(!0)},F.mousetool.text.searchdelay),!1):void d())}function s(e){var t=n.val();return 13===e.keyCode&&a&&t&&a.isValid()&&a.getQuery()===t?(e.shiftKey?u():c(),!1):13!==e.keyCode||a&&a.isValid()?27===e.keyCode?(d(),b(),!1):void 0:(l(),!1)}function c(){a&&(f(!0),a.next(h))}function u(){a&&(f(!0),a.prev(h))}function d(){a=null,E.text.search(""),E.text.clearSelection(),f(!1),p(!0)}function h(e,t){e.isValid()&&(f(!1),e.wrap=F.mousetool.text.wrapsearch,t||p(t))}function f(e){m(o.loading,e)}function p(e){m(o.inputEmpty,!e)}function g(t){return function(e){e.preventDefault(),t&&t()}}function m(e,t){t?n.addClass(e):n.removeClass(e)}function v(e){m(o.onclear,this.offsetWidth-18<e.clientX-this.getBoundingClientRect().left)}function b(e){e&&e.preventDefault(),n.removeClass(o.clearable).removeClass(o.onclear).val("").change(),l()}!function(){t=I().addClass(an.atala_search_container).addClass("ui-controlgroup-item"),(n=Qt('<input type="text" placeholder="Search..." />').addClass(an.atala_search_input).addClass("ui-widget")).on({keydown:s,"input propertychange":l}),w("span",t).css({width:"100%"}).append(n);var e=w("span",t);L(e,null,y+" "+y+"-search-next","Next",null,g(c)).addClass(an.atala_search_next).addClass(an.atala_toolbar_button),L(e,null,y+" "+y+"-search-prev","Previous",null,g(u)).addClass(an.atala_search_prev).addClass(an.atala_toolbar_button),t.on("mousemove","."+o.clearable,v).on("touchstart click","."+o.onclear,b),i.append(t),i.append(Qt('<div style="clear:both;"></div>'))}(),this.dispose=function(){n.off({keypress:s,"input propertychange":l}),t.off("mousemove","."+o.clearable,v).off("touchstart click","."+o.onclear,b),a&&a.dispose();t.remove()}}function j(){F.allowannotations&&c.annotations.cancelDraw(),E.mouseTool.setTool($t.ZoomArea)}function N(o){return function(){var t=this,e=q(S),i=e[0],n=[];e.forEach(function(e){return Dn(this,t),n.push(E.document.getPageRotation(e)+o)}.bind(this)),E.document.rotatePages(e,n,function(){var e=ht(i),t=he(i),n=F.direction===en.Vertical?t.height*e:0;Ye(F.pageselectlocation,nn.Center)||Ye(F.pageselectlocation,nn.MiddleLeft)?n/=2:Ye(F.pageselectlocation,nn.TopLeft)&&(n=0);var o={x:F.direction===en.Vertical?0:n,y:F.direction===en.Vertical?n:0};Ge(i,o,F.pageselectlocation,!0)})}}!function(){var e=F.parent.attr("id")+"_wdv";++fn.instanceCounter;for(;document.getElementById(e+fn.instanceCounter);)++fn.instanceCounter;s=e+fn.instanceCounter}(),
/**
   * @member {WebDocumentViewerConfig} config - Current control configuration.
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @instance
...
c.domclasses=an,
/** WARNING: Changing values from these references can cause instability.*/
c.domattributes=rn;var q=function(e){return[e.number-1]};function U(e,t){var n=I(e,t);return F.direction===en.Vertical?(n.height(1),n.css({display:"block"})):F.direction===en.Horizontal&&(n.width(1),n.css({display:"inline-block",overflow:"hidden"})),n._zoom=1,F.backcolor&&n.css({backgroundColor:F.backcolor}),n}function W(e){if(void 0===e){var t=Q(k&&M.newpagedivsize&&0<F.zoom&&isFinite(F.zoom)?F.zoom:K());S.buffer<t&&(S.buffer=t),S.buffer=Math.min(S.buffer,E.document.getPageCount()),e=S.buffer}function n(t){return function(){var e;e=t,M.activepage=e}}if(x.pageDivs.length<e)for(var o=x.pageDivs.length;o<e;o++)x.pageDivs[o]=I(),x.pageDivs[o].addClass(an.atala_page_div),F.showselecttools&&(x.pageDivs[o]._rubberband=new Pn(c,{},x.pageDivs[o],{getViewportSize:fe,getMaxZoom:$,getPageOffsets:le,raiseDrawLayer:yt,resetDrawLayer:xt})),x.pageDivs[o].on({touchstart:n(x.pageDivs[o]),mousedown:n(x.pageDivs[o])}),E.annotations&&E.annotations.addDrawingSurface(x.pageDivs[o]),(F.showselecttools||F.allowannotations||F.allowforms||F.allowtext)&&(x.pageDivs[o]._draw=z(x.pageDivs[o])),E.forms&&!k&&E.forms.addFormLayer(x.pageDivs[o]),E.text&&!k&&E.text.addTextLayer(x.pageDivs[o]);else if(x.pageDivs.length>e)for(;x.pageDivs.length>e&&0!==x.pageDivs.length;){var i=x.pageDivs.pop();i._rubberband&&i._rubberband.dispose(),E.annotations&&E.annotations.removeDrawingSurface(i),E.forms&&!k&&E.forms.removeFormLayer(i),E.text&&!k&&E.text.removeTextLayer(i),i&&Le(i),i=null}}function Z(e,r,t,n){"function"==typeof t&&(n=t,t=void 0);var o="function"==typeof n?[n]:[],u=Qt(new Image),i=.9,l=Qt.extend(!0,{atala_cb:void 0},t||{});u._domEl=I(),u._domEl.addClass(an.atala_page_image_anchor),u.addClass(an.atala_page_image),u._domEl.append(u);var a={load:v,error:function(){z(),A("ImageError","Image at frameIndex "+d()+" failed to load.")},inserted:function(){u._loaded&&b()}};function d(){return u._page?u._page._index:E.document.getPageIndexByImageIndex(u._index)}function s(){return u._domEl}function c(e){return E.document.getPageFitMultiplier(void 0!==e?e:d())}function h(e,t){return(e=void 0===e?F.zoom:e)*c(t)}function f(){var e=he(d())||S.size;return{height:e.height,width:e.width}}
/**
     * Returns physical size of the image without client transformations applied(like view rotation)
     */function p(){var e=f();return 90===u._viewrotation||270===u._viewrotation?T(e):e}function g(e,t){return t=t||f(),{height:Math.round(t.height*h(e)),width:Math.round(t.width*h(e))}}function m(e){var t=d(),n=S.vector&&(!r||!r.uri)?h():Math.min(h(),1),o=E.document.getPageRotation(t);if(e||n!==u._zoom||u._rotation!==o){var i=Qt.extend({atala_docurl:r?r.uri:u.documenturl,atala_doczoom:n,atala_thumbpadding:!1},l);o&&(i.atala_angle=o),F.jpeg&&(i.atala_jpeg=!0);var a={type:"docpage",serverurl:F.serverurl,query:"?ataladocpage="+(null===r?u._index:void 0!==r.index?r.index:r),method:"GET",data:i,cancel:!1,info:u};u._reqzoom=n,u._reqangle=o,Vt(a,v,v)}}function v(){u._loaded||u._domEl.removeClass(an.atala_page_loading),u._loaded=!0,u._zoom=u._reqzoom,u._rotation=u._reqangle;var e=d();if(0<=e){if(u._rotation!==E.document.getPageRotation(e))return void m();(u._viewrotation=0)<u.parent().length&&b(),D(u._viewrotation);var t=S.vector?h():Math.min(h(),1);x()&&u._zoom<t*i&&!J(u._zoom,t)&&y(!1)}z()}function b(){var e;(e=u)&&(e.removeAttr("width height"),e.css({width:"auto",height:"auto"}));var t=u.prop("naturalWidth")||0,n=u.prop("naturalHeight")||0,o=t||u.width(),i=n||u.height(),a=f(),r=h(),l=!1;if(0!==o&&0!==i){var s;u._size.width=Math.round(o/u._zoom),u._size.height=Math.round(i/u._zoom),90!==u._viewrotation&&270!==u._viewrotation||(u._size=T(u._size)),u._size.width===S.size.width&&u._size.height===S.size.height||J(u._size.width,a.width)&&J(u._size.height,a.height)||(l=!0,E.document.setPageSize(d(),u._size)),null===E.document.getPageSize(d())&&(l=!0,E.document.setPageSize(he,u._size)),F.forcepagefit?(s=function(e){e=e||u._size;var t={width:F.forcepagesize.width*(k?1:F.zoom),height:F.forcepagesize.height*(k?1:F.zoom)};return(t.width<1||t.height<1)&&(t.width=S.size.width*F.zoom,t.height=S.size.height*F.zoom),e.width/t.width>e.height/t.height?t.width/e.width:t.height/e.height}()/F.zoom,E.document.setPageFitMultiplier(d(),s),w()):(u._zoom!==F.zoom||l||0!==u._viewrotation)&&w();var c=g();l&&u.trigger({type:"pagesizechanged",image:u,index:d(),width:u._size.width,height:u._size.height,dx:Math.round(c.width-a.width*r),dy:Math.round(c.height-a.height*r)}),u.trigger({type:"pageresize",image:u,index:d(),width:c.width,height:c.height})}}function y(e,t){x()&&!u._size.isEmpty()?("function"==typeof t&&o.push(t),u._prevzoom=u._reqzoom,e&&!M.loading?u.animate({height:Math.round(u._size.height*h()),width:Math.round(u._size.width*h())},{duration:C,easing:"easeOutQuad",complete:_,queue:!1}):(w(),_())):"function"==typeof t&&t.call(this,u)}function x(){if(!u._loaded)return!1;var e=!S.vector&&1===u._reqzoom&&1===u._prevzoom&&1<h(),t=J(u._reqzoom,h())||e;if(!t){var n=Math.abs(u._reqzoom*u._size.width-h()*u._size.width),o=Math.abs(u._reqzoom*u._size.height-h()*u._size.height);n<1&&o<1&&(t=!0)}return!t||!J(u._scaledzoom,h())}function _(){u.trigger({type:"pagezoom",index:d(),height:Math.round(u._size.height*h()),width:Math.round(u._size.width*h()),prevzoom:u._prevzoom,zoom:h()}),0===M.prpr?m():z()}function w(){var e,t,n,o=g(void 0,p()),i=g(),a=u.prop("naturalWidth")||0,r=u.prop("naturalHeight")||0,l=a&&Math.abs(a-o.width)/o.width<.01,s=r&&Math.abs(r-o.height)/o.height<.01;l&&s||(u.height(o.height),u.width(o.width)),u._domEl.width(i.width),u._domEl.height(i.height),u._scaledzoom=h(),D(u._viewrotation),e=d(),t=i.width,i.height,null!=(n=Xe(e))&&null!=n._num&&n._num.css({left:t-20,right:0})}function z(){0<o.length&&function(e){var t=Array.prototype.slice.call(arguments,1);for(;e.length;)e.shift().apply(this,t)}(o,u)}function P(){var e=E.document.getPageRotation(d());return 0===u._viewrotation&&e!==u._rotation||0!==u._viewrotation}function D(e){var t=p(),n=g(void 0,t),o=0,i=0,a="";90!==e&&270!==e||(o=(n.height-n.width)/2,k&&t.width<t.height&&(o=0),i=(n.width-n.height)/2,n=T(n)),0!==e?(a+=" translate("+o+"px,"+i+"px)",a+="rotate("+e+"deg)",u.css(dn(a))):u.css(dn("")),s().css({width:n.width,height:n.height}),u._viewrotation=e}function T(e){var t=e.width;return e.width=e.height,e.height=t,e}return u._binds=a,u.documenturl=F.documenturl,u._index=r?r.mapsto:e,u._loaded=!1,u._size={width:0,height:0,isEmpty:function(){return 0===this.width&&0===this.height}},u._zoom=-1,u._prevzoom=u._zoom,u._scaledzoom=-1,u._rotation=0,u._viewrotation=0,u.dispose=function(){u.off(a),u._page=null,u=null},u.zoom=y,u.needsZoom=x,u.getSize=f,u.getScaledSize=g,u.getFitZoom=h,u.getFitMultiplier=c,u.needsRotate=P,u.rotate=function(e){"function"==typeof e&&o.push(e);if(P()){var t=E.document.getPageRotation(d());if(n=E.document.getPageRotation(d()),(0===u._viewrotation&&n!==u._rotation||0!==u._viewrotation&&(u._viewrotation+u._rotation)%360!==n)&&u&&u._loaded&&u._page&&(D(t=(360+t-u._rotation)%360),b()),0===M.prpr&&u._loaded)return void m()}var n;z()},u.getDomElement=s,u.invalidate=function(e,t){"function"==typeof e&&(t=e,e={});(l=Qt.extend(!0,{},e)).atala_cb=Math.floor(1e9*Math.random()),"function"==typeof t&&o.push(t);m(!0)},function(){u.on(a);var e=F.pageborderwidth,t={bottom:0,top:0,right:0,left:0};u._loaded=!1,u._reqzoom=-1,(F.direction===en.Vertical||F.tabular)&&(t.bottom=F.pagespacing);(F.direction===en.Horizontal||F.tabular)&&(t.right=F.pagespacing);var n=s();F.showpageborder&&n.css({"border-bottom":e+"px solid black","border-right":e+"px solid black","border-top":e+"px solid silver","border-left":e+"px solid silver","margin-bottom":t.bottom+"px","margin-right":t.right+"px"});n.css({display:"inline-block"}),n.addClass(an.atala_page_loading),m()}(),u}function X(e,t){var n="overflow:scroll; position:absolute; background-color:Transparent;",o=I(e);o.css({position:"absolute",display:"none","background-color":"white"});var i=null,a=!1;function r(){i._tooltip.hide(),S.number===i._pagenum||Ze(i._pagenum)||Ae(i._pagenum),Mt()}function l(e,t){if(F.forcepagefit){t*=e._ratio;var n=e.ScrollDirection===en.Vertical?{x:0,y:t}:{x:t,y:0};return oe(n.x,n.y)+1}return Math.floor(t/(e._max/E.document.getPageCount()))+1}return t===en.Horizontal?(Kt.Firefox&&(n=n.replace("overflow","overflow-x")),(i=Qt('<div style="'+n+'bottom:0px; left:0px; width:100%;z-index:10"></div>').appendTo(e))._tray=Qt('<div style="height:1px;"></div>').appendTo(i)):(Kt.Firefox&&(n=n.replace("overflow","overflow-y"),n+="width:"+(function(){var e=I(Qt("body")),t=I(e);e.css({width:"50px",height:"50px",overflow:"hidden",position:"absolute",visibility:"hidden"}),t.css({width:"100px",height:"100px"});var n=e.width();e.css({"overflow-y":"scroll"});var o=n-e[0].clientWidth;return Qt(e).remove(),o}()+1)+"px;",a=!0),(i=Qt('<div style="'+n+'top:0px; right:0px; height:100%;z-index:10"></div>').appendTo(e))._explicitSize=a,i._tray=Qt('<div style="width:1px;"></div>').appendTo(i)),Y(i),i._ratio=1,i.ScrollDirection=t,i._tooltip=o,i._pagenum=-1,i._scrollSize=0,i.pageNum=function(e){i._pagenum=e},i.scrollbarHeight=function(){return i.height()-i[0].clientHeight},i.scrollSize=function(e){i._scrollSize=e},i.ratio=function(e){i._ratio=e},i.on({scroll:function(){if(!i.propagationPaused()){clearTimeout(i._tooltip._timeout),x.scroller.stop(),x.scroller.pauseEventPropagation(!0);var e={};i.ScrollDirection===en.Vertical?(x.scroller.scrollTop(i[0].scrollTop*i._ratio),i._pagenum=l(i,i[0].scrollTop),e.right=i.outerWidth()+10+"px",e.top=16+Math.round((i[0].offsetHeight-48)/i[0].scrollHeight*i[0].scrollTop)+"px"):i.ScrollDirection===en.Horizontal&&(x.scroller.scrollLeft(i[0].scrollLeft*i._ratio),i._pagenum=l(i,i[0].scrollLeft),e.bottom=i.outerHeight()+10+"px",e.left=16+Math.round((i[0].offsetWidth-48)/i[0].scrollWidth*i[0].scrollLeft)+"px"),i.ScrollDirection===F.direction&&F.showpagenumbertooltip&&("none"===i._tooltip.css("display")&&(i._tooltip.css(e),i._tooltip.show()),F.showpagenumbertooltip&&i._tooltip.html("Page "+i._pagenum),i._tooltip._timeout=setTimeout(r,1e3))}}}),i}function G(e){e&&e._tooltip&&(clearTimeout(e._tooltip._timeout),e._tooltip.hide())}function Y(t){var n={scroll:function(){t.off(n),t.resumeEventPropagation()}};t._pauseEP=0,t.propagationPaused=function(){return 0<t._pauseEP},t.pauseEventPropagation=function(e){t._pauseEP++,e&&t.on(n)},t.resumeEventPropagation=function(){0<t._pauseEP&&t._pauseEP--}}function Q(e){var t=fe(),n=ee(0,e);!M.hidden&&t.height<=0&&t.width<=0&&(M.hidden=!0,function(){var e=this;if(Kt.Edge||Kt.Explorer)var t=setInterval(function(){Dn(this,e),0!==x.scroller.height()&&0!==x.scroller.width()&&(clearInterval(t),M.hidden=!1,Yt("viewportunhide"))}.bind(this),500);else{var n=new ResizeObserver(function(){Dn(this,e),M.hidden=!1,Yt("viewportunhide"),n.unobserve(x.scroller[0])}.bind(this));n.observe(x.scroller[0])}}()),n.width=0<S.smallest.width&&S.smallest.width<n.width&&!k?S.smallest.width:n.width,n.height=0<S.smallest.height&&S.smallest.height<n.height&&!k?S.smallest.height:n.height;var o,i=Math.ceil(t.width/n.width)+2,a=Math.ceil(t.height/n.height)+2;return F.tabular?(F.direction===en.Vertical&&0<F.columns?i=F.columns:F.direction===en.Horizontal&&0<F.rows&&(a=F.rows),o=i*a):F.direction===en.Vertical?o=a:F.direction===en.Horizontal&&(o=i),o}function J(e,t){return t<e+.001&&e-.001<t}function K(){return 0!==S.size.width?F.minwidth/S.size.width:1}function $(){return 0!==S.size.width?F.maxwidth/S.size.width:1}function ee(e,t,n){if(E.document.getPageCount()<=0)return{width:0,height:0};if(n=void 0===n||n,M.newpagedivsize){var o={width:M.newpagedivsize.width,height:M.newpagedivsize.height},i=F.showpageborder&&n?2*F.pageborderwidth:0,a=(t||F.zoom)/M.newpagedivfullzoom;return o.height=Math.round(o.height*a)+i,o.width=Math.round(o.width*a)+i,o}return te(e,t||F.zoom,F.showpageborder&&n)}function te(e,t,n){var o,i=Qt.extend({},he(e)),a=n?2*F.pageborderwidth:0;return t*=(o=e,E.document.getPageFitMultiplier(o)),i.height=Math.round(i.height*t)+a,i.width=Math.round(i.width*t)+a,i}function ne(e,t){return le(null,e,t).index}function oe(e,t){var n=re(),o=fe();if(F.direction===en.Vertical){var i=0;if(x.scrollH&&(i=1,"none"!==x.scrollH.find("div").css("display")||Kt.Firefox||(i=x.scrollH.outerHeight(!0))),t>=n.height-o.height-i&&0<M.scrollTargetPage)return M.scrollTargetPage-1}var a=x.scrollV&&"none"!==x.scrollV.find("div").css("display")?1:0;if(F.direction===en.Horizontal&&e===n.width-o.width-a&&0<M.scrollTargetPage)return M.scrollTargetPage-1;var r={x:e+F.pageselectlocation.x*o.width,y:t+F.pageselectlocation.y*o.height};return ne(r.x,r.y)}function ie(e,t){for(var n={left:0,top:0},o=e;null!=o&&o!==t;o=o.offsetParent)n.left+=o.offsetLeft,n.top+=o.offsetTop;return n}var ae={height:0,isEmpty:function(){return 0===this.width&&0===this.height},width:0,zero:function(){this.width=0,this.height=0},zoom:1};function re(){if(ae.isEmpty()||ae.zoom!==F.zoom){var e=le(null,null,null,F.zoom);ae.height=e.height,ae.width=e.width,ae.zoom=F.zoom}return ae}function le(e,t,n,o){return se(0,e,t,n,o)}function se(e,t,n,o,i){if(F.tabular)return function(e,t,n,o,i){if(t<e)return{width:0,height:0,index:t};var a=ce(e,n,o,i),r=ce(t,n,o,i);return r.height=F.direction===en.Vertical?r.height-a.height:r.height,r.width=F.direction===en.Horizontal?r.width-a.width:r.width,r}(e,t,n,o,i);var a=E.document.getPageCount();t=t||0===t?t:a;var r={height:0,width:0,index:e=e||0};if(F.direction===en.Vertical)for(var l=null,s=e;s<a&&s<t&&(r.height+(l=ee(s,i).height)<=o||null==o);s++)r.height+=l+F.pagespacing,r.index++;else if(F.direction===en.Horizontal)for(var c=null,u=e;u<a&&u<t&&(r.width+(c=ee(u,i).width)<=n||null==n);u++)r.width+=c+F.pagespacing,r.index++;return r.index>=a&&0<a&&(r.index=a-1),r}function ce(e,t,n,o){var i,a,r=E.document.getPageCount(),l={height:0,width:0,index:0},s=ue(o);e=null==e?e=r:e,F.direction===en.Vertical?(i=s||1,a=Math.ceil(r/i)):F.direction===en.Horizontal&&(a=s||1,i=Math.ceil(r/a));var c=ee(0,o);c.width+=F.pagespacing,c.height+=F.pagespacing;var u=null==n?Math.floor(e/i):Math.floor(n/c.height),d=null==t?e%i:Math.ceil(t/c.width);return l.height=u*c.height,l.width=d*c.width,l.index=u*i+d,l.index>=r&&0<r&&(l.index=r-1),l}function ue(e){var t=1;if(F.tabular){var n=F.pagespacing||0,o=ee(0,e);F.direction===en.Vertical?(t=Math.floor(x.content.width()/o.width),t=Math.min(t,Math.floor((x.content.width()-t*n)/o.width))):F.direction===en.Horizontal&&(t=Math.floor(x.content.height()/o.height),t=Math.min(t,Math.floor((x.content.height()-t*n)/o.height)))}return t||1}function de(e,t){var n=he(e);return(ft(e)+(t||0))%180==0?n:{width:n.height,height:n.width}}function he(e){var t=E.document.getPageSize(e);return t||S.size}function fe(){return{width:x.scrollV?x.main.width()-x.scrollV.outerWidth():x.main.width(),height:x.scrollH?x.main.height()-x.scrollH.outerHeight():x.main.height()}}function pe(e,t){var n={status:"fail",started:!1,reason:e};return"function"==typeof t&&t.call(),n}function ge(e,t,n,o,i,a){var r=ie(e,t);return r.left<=i&&r.left+e.clientWidth>=n&&r.top<=a&&r.top+e.clientHeight>=o}function me(e,t,n){return t<e.length&&(e.splice(n,0,e.splice(t,1)[0]),!0)}function ve(e){F.showstatus&&x.status&&x.status.html(e),Yt({type:"statusmessage",message:e})}function be(e,t){var n;if(1===e.length&&"object"==typeof e[0])n=e[0];else if("string"==typeof e[0]){n={};var o=null;3===e.length?o=e[2]:2===e.length&&(o=e[1]);for(var i=-1<e[0].indexOf(" ")?e[0].split(" "):[e[0]],a=0;a<i.length;a++)n[i[a]]=o}for(var r in n)if(n.hasOwnProperty(r)){var l=null;if(r in d?l=d:c&&r in c.annotations.events?l=c.annotations.events:c&&r in c.forms.events?l=c.forms.events:c&&r in c.document.events&&(l=c.document.events),null==l&&(l=d),null==l[r])t&&(l[r]=[n[r]]);else if(t)l[r].push(n[r]);else if(n[r])for(var s=0;s<l[r].length;s++)l[r][s]===n[r]&&l[r].splice(s,1);else l[r].length=0}}function ye(e,t){return t?isFinite(parseFloat(e)):isFinite(parseInt(e,10))}function xe(e,t,n,o,i){if(null==i&&"function"==typeof o&&(i=o,o=null),e=null==e?x.scroller.scrollLeft():e,t=null==t?x.scroller.scrollTop():t,F.direction===en.Horizontal){if(e>x.viewport.width()){var a=re();if(e<a.width&&0<x.content.width()){var r=a.width-(x.edges[0].width()+x.content.width());x.edges[1].width(r)}}}else if(F.direction===en.Vertical&&t>x.viewport.height()){var l=re();if(t<l.height&&0<x.content.height()){var s=l.height-(x.edges[0].height()+x.content.height());x.edges[1].height(s)}}x.scroller.stop(),!n||M.loading||M.scrollPos.x===e&&M.scrollPos.y===t?(x.scroller.scrollLeft(e),x.scroller.scrollTop(t),"function"==typeof i&&i.call()):Qt.when(x.scroller.animate({scrollLeft:e,scrollTop:t},{duration:o||u,easing:"easeOutQuad",queue:!1})).done(i)}function _e(e,t){if(x.scroller.is(":animated"))return pe("scrolling",t);var n=le(S.number+e-1);xe(n.width,n.height,!0,t)}function we(){if(x.scrollH&&x.scrollV){var e=E.document.getPageCount();if(x.scrollH.pauseEventPropagation(),x.scrollV.pauseEventPropagation(),F.direction===en.Vertical){ze(x.scrollH,"width");var t=Math.round(le(e-1).height+ee(e-1).height);Kt.Firefox&&(t+=Math.round(x.scrollH.scrollbarHeight())),x.scrollV.scrollSize(t-(x.scrollV.height()-x.scrollH.scrollbarHeight()-1)),3e4<t?(x.scrollV.ratio(t/(3e4-(x.scrollV.height()-x.scrollH.scrollbarHeight()-1))),x.scrollV._tray.height(3e4)):(x.scrollV._tray.height(t),x.scrollV.ratio(1)),Pe(x.scrollV)}else if(F.direction===en.Horizontal){ze(x.scrollV,"height");var n=Math.round(le(e-1).width+ee(e-1).width);x.scrollH.scrollSize(n),3e4<n?(x.scrollH.ratio(n/(3e4-(x.scrollH.width()-x.scrollV.width()-1))),x.scrollH._tray.width(3e4)):(x.scrollH._tray.width(n),x.scrollH.ratio(1)),Pe(x.scrollH)}x.scrollV._max=Math.max(x.scrollV._tray.height()-x.scrollV.height(),0)+1,x.scrollH._max=Math.max(x.scrollH._tray.width()-x.scrollH.width(),0)+1,x.scrollH.resumeEventPropagation(),x.scrollV.resumeEventPropagation()}}function ze(e,t){if(e){var n=Math.round(S.size[t]*F.zoom);if(F.tabular)n=x.content[t]();else for(var o=0;o<x.pageDivs.length;o++)null!=x.pageDivs[o]._index&&(n=Math.max(ee(x.pageDivs[o]._index)[t],n));e._tray[t](n),e.scrollSize(n-e[t]()),Pe(e),e.ratio(1)}}function Pe(e){e&&(e._scrollSize<=0?e._tray.hide():e._tray.show())}function De(e){if(!M.zooming&&!M.scrollBuffer&&x.pageDivs.length){var t=(new Date).getTime(),a=x.scroller[0].scrollLeft,r=x.scroller[0].scrollTop,n=a+x.scroller[0].clientWidth,o=r+x.scroller[0].clientHeight,i=ne(a,r)+1,l=Math.abs(i-S.number)/ue();if(!M.loading){var s=E.document.getPageCount(),c=x.pageDivs[0]._index,u=x.pageDivs[x.pageDivs.length-1]._index,d=0===l&&(S.number-1<c||S.number-1>u);l<x.pageDivs.length&&!d?ge(x.edges[1][0],x.scroller[0],a,r,n,o)&&u<s-1?Me(l):ge(x.edges[0][0],x.scroller[0],a,r,n,o)&&0<c?Se(l):i!==S.number&&null===Xe(i-1)&&Ae(i):Ie(i,!1,null),ct()}if(Oe(oe(a,r)+1),!x.scroller.propagationPaused()&&x.scrollH&&x.scrollV){var h=Math.round(a/x.scrollH._ratio),f=Math.round(r/x.scrollV._ratio);h!==x.scrollH.scrollLeft()&&(x.scrollH.pauseEventPropagation(!0),x.scrollH.scrollLeft(h)),f!==x.scrollV.scrollTop()&&(x.scrollV.pauseEventPropagation(!0),x.scrollV.scrollTop(f))}Yt({type:"scroll",x:a,y:r,dx:a-M.scrollPos.x,dy:r-M.scrollPos.y}),e&&(M.scrollTimeout&&clearTimeout(M.scrollTimeout),M.scrollTimeout=setTimeout(function(){var e,t,n,o,i;e=a,t=r,n=x.scroller[0].scrollLeft,o=x.scroller[0].scrollTop,i=n===M.scrollPos.x&&o===M.scrollPos.y,e===M.scrollPos.x&&t===M.scrollPos.y&&i?(Mt(),M.scrollTimeout=null,M.loading||ct()):i||(De({}),M.scrollTimeout=null)},500),M.scrollPos.x=x.scroller[0].scrollLeft,M.scrollPos.y=x.scroller[0].scrollTop,M.scrollPos.t=t),M.scrollBuffer=e?setTimeout(Te,50):null}}function Te(){null!==M.scrollBuffer&&(clearTimeout(M.scrollBuffer),M.scrollBuffer=null)}function ke(){if(F.direction===en.Horizontal){var e=x.pageDivs.length?(k?Math.max(S.size.height,S.size.width):S.size.height)*F.zoom:0;F.thumbpadding&&"number"==typeof F.thumbpadding&&(e+=2*F.thumbpadding),x.edges[0].height(e),x.edges[1].height(e)}}function Ce(e,t){t=t||0===t?t:e+x.pageDivs.length-1,t=Math.max(e,t);var n=F.tabular?ue():1,o=F.tabular?(Math.floor(t/n)+1)*n-t:1,i=le(e),a=E.document.getPageCount(),r=t<a?ee(t):{width:0,height:0},l=t<a-n?ee(a-1):{width:0,height:0},s=se(e,t);s.width+=r.width,s.height+=r.height;var c=se(t+1,a-1);if(c.width+=l.width,c.height+=l.height,F.direction===en.Vertical)if(x.edges[0].height(i.height),t+o>=E.document.getPageCount()){var u=i.height+s.height+c.height;x.scrollH&&u>x.scroller[0].clientHeight&&x.content.width()<=x.scroller[0].clientWidth?x.edges[1].height(x.scrollH.scrollbarHeight()):x.edges[1].height(0)}else x.edges[1].height(c.height),Kt.Chrome&&x.content.height("");else if(F.direction===en.Horizontal)if(x.edges[0].width(i.width),t+o>=E.document.getPageCount()){var d=i.width+s.width+c.width;x.scrollV&&d>x.scroller[0].clientWidth&&x.content.height()<=x.scroller[0].clientHeight?x.scrollV._explicitSize?x.edges[1].width(x.scrollV.height()<x.scrollV._tray.height()?x.scrollV.width():0):x.edges[1].width(x.scrollV.width()):x.edges[1].width(0)}else x.edges[1].width(c.width),x.edges[1].height(1)}function Ee(){return M.activepage}function Se(e){if(e=e||1,0===M.prpr&&0<x.pageDivs.length){var t=ue(F.zoom);je();for(var n=e;0<n;n--){var o=x.pageDivs[0]._index-t;if(0<=o&&o<E.document.getPageCount()){for(var i=t-1;0<=i;i--){var a=qe(-1);He(a),x.content.prepend(a),Be(a,We(o+i),o+i)}Ce(o,null),ke()}}setTimeout(Ne,10)}}function Me(e){e=e||1;var t=x.pageDivs[x.pageDivs.length-1]._index+1;if(0===M.prpr&&0<x.pageDivs.length&&t<E.document.getPageCount()){je();for(var n=ue(F.zoom),o=E.document.getPageCount(),i=e;0<i;i--){var a=x.pageDivs[x.pageDivs.length-1]._index+1;if(a<o){for(var r=a+n-1-x.pageDivs.length,l=0;l<n;l++){var s=qe(1);He(s),x.content.append(s),Be(s,We(a+l),a+l)}Ce(r+1,a),ke()}}setTimeout(Ne,10)}}
/**
   * Scrolls the viewer to the given page index and executes the callback when finished.
   * @param {number} index - Index of the page to show.
   * @param {NotificationCallback} [callback] - Function to execute after this operation is done.
...
/**
   ...
   * @function showPageNumber
   * @deprecated Please use {@link Atalasoft.Controls.WebDocumentViewer#showPage|showPage} instead.
   */function Ae(e,t){var n=this;if(F.direction===en.Vertical?x.scrollV&&clearTimeout(x.scrollV._tooltip._timeout):F.direction===en.Horizontal&&x.scrollH&&clearTimeout(x.scrollH._tooltip._timeout),e=Math.max(1,e),e=Math.min(E.document.getPageCount(),e),k||M.zooming||(M.scrollTargetPage=e),S.number!==e){var o=e-S.number;Math.abs(o)<x.pageDivs.length?_e(o,t):Ie(e,!0,t)}else _e(0,t);setTimeout(function(){return Dn(this,n),M.scrollTargetPage=0}.bind(this),1e4)}function Ie(e,t,n){var o=E.document.getPageCount(),i=e-1;if(0===M.prpr&&0<o){var a=function(){Ne(!t),"function"==typeof n&&n.call()};je();var r=0,l=0,s=i<=0?0:i;if(s+x.pageDivs.length>=o){if(s=o-x.pageDivs.length,F.tabular){var c=ue();s=Math.ceil(s/c)*c}s=Math.max(s,0)}if(F.direction===en.Vertical){r=le(s).height,x.edges[0].height(r),Ce(s,null),ke(),Ve();for(var u=0;u<x.pageDivs.length;u++)x.content.append(x.pageDivs[u]),Be(x.pageDivs[u],null,s+u);var d=le(Math.max(i,0)).height,h=S.number<e?-S.size.height:S.size.height;t&&d!==M.scrollPos.y?(xe(null,d+h,!1),xe(null,d,!0,a)):a.call()}else if(F.direction===en.Horizontal){l=le(s).width,x.edges[0].width(l),Ce(s,null),ke(),Ve();for(var f=0;f<x.pageDivs.length;f++)x.content.append(x.pageDivs[f]),Be(x.pageDivs[f],null,s+f);var p=le(Math.max(i,0)).width,g=S.number<e?-S.size.width:S.size.width;t&&p!==M.scrollPos.x?(xe(p+g,null,!1),xe(p,null,!0,a)):a.call()}}else pe("paused",n)}function Oe(e){var t=E.document.getPageCount();if(0<e&&e<=t){if(S.number!==e||S.numberoutof!==t){if(x.pageLabel.html(e+" / "+t),S.number!==e){S.number=e;for(var n=0;n<x.pageDivs.length;n++){var o=x.pageDivs[n];o._index===e-1?o.addClass(an.atala_active_page):o.removeClass(an.atala_active_page)}Yt({type:"pagenumberchanged",number:S.number})}S.numberoutof!==t&&(S.numberoutof=t)}}else x.pageLabel.html(""),x.viewport.find("."+an.atala_active_page).removeClass(an.atala_active_page),S.numberoutof=0}function Ve(){for(var e=x.pageDivs.length-1;0<=e;e--)He(x.pageDivs[e])}function He(e){Kt.Explorer&&document.activeElement&&e.has(document.activeElement).length&&x.scroller.focus(),F.allowannotations&&(Kt.Firefox||Kt.Edge)&&E.annotations.__clearAllSelection(e),e.detach(),null!=e._img&&(e._img._page=null,e._img.getDomElement().detach(),e._img=null),Yt({type:"pagerecycled",index:e._index,page:e}),e._index=-1,e.removeAttr(rn.atala_page_index)}function Le(e){He(e),e._index=-1,e.removeAttr(rn.atala_page_index),e._img=null,e.remove()}function Be(t,e,n,o){if(t._index===n&&t._img===e&&!o)return!1;if(o&&!t.nullinserted&&n<0)return!1;if(t._index=n,t.attr(rn.atala_page_index,n),n>=E.document.getPageCount())return t.hide(),!1;if(t._img&&t._img!==e&&(t._img._page=null,0<t.has(t._img.getDomElement()).length&&t._img.getDomElement().detach(void 0,!0)),t._rubberband&&t._rubberband.reset(),t._img=e,t._img&&(t._img._page=t),t.css({display:F.tabular||F.direction===en.Horizontal?"inline-block":"block"}),F.showpagenumber&&(t.css({position:"relative"}),t._num||(t._num=Qt('<div style="position:absolute; right:20px; bottom:16px;z-index:1"/>'),t._num.addClass(an.atala_page_number),t.append(t._num)),t._num.text(t._index+1)),t._img&&t._img._binds&&(t._img._binds.pageresize||(t._img._binds.pageresize=function(e){Yt({type:"pageresize",page:e.image._page,image:e.image,index:e.image._page?e.image._page._index:E.document.getPageIndexByImageIndex(e.image._index),width:e.width,height:e.height})},t._img.on({pageresize:t._img._binds.pageresize})),t._img._binds.pagesizechanged||(t._img._binds.pagesizechanged=function(e){Yt({type:"pagesizechanged",page:t,image:e.image,index:e.index,width:e.width,height:e.height,dx:e.dx,dy:e.dy})},t._img.on({pagesizechanged:t._img._binds.pagesizechanged}))),t._img){var i=t._img.getDomElement();t.append(i),t._img.trigger({type:"inserted",page:t}),t._img._loaded||(t.nullinserted?t._img.css({width:t.width(),height:t.height()}):Re(t._img,t._index)),M.newpagedivsize||t.css({width:"",height:""}),t.nullinserted=!1}else t.nullinserted=!0,M.newpagedivsize||Re(t,t._index);return Yt({type:"pageshown",page:t,index:t._index}),!0}function Re(e,t){var n=ee(t,null,!1);e.css({width:n.width,height:n.height})}function je(){M.prpr++}function Ne(e){0!==M.prpr&&(M.prpr--,0!==M.prpr||e||De())}function qe(e){return 0<e?(me(x.pageDivs,0,x.pageDivs.length-1),x.pageDivs[x.pageDivs.length-1]):(me(x.pageDivs,x.pageDivs.length-1,0),x.pageDivs[0])}
/**
   * Checks whether specified document page have been loaded.
   * @param {number} index - Page index.
   * @returns {boolean} `true` if page have already been loaded; `false` otherwise.
...
/**
   ...
   * @return {object} page reload promise
   */
function Ue(e,t){var n=Qt.Deferred();0<=e.cacheIndex&&x.loadedImgs[e.cacheIndex]?x.loadedImgs[e.cacheIndex].invalidate(t,function(){n.resolve()}):n.resolve();return n.promise()}function We(e,t,n){"function"==typeof t&&(n=t,t=void 0);var o=E.document.getPageDefinition(e);if(o){if(o.cacheIndex<0||!x.loadedImgs[o.cacheIndex]){var i=M.nextImageCacheIndex++;o.cacheIndex=i,E.document.setPageCacheIndex(e,i),x.loadedImgs[i]=Z(o.index,o.ref,t,function(e){e&&((x.loadedImgs[i]=e)._cacheIndex=i,E.memory.allocate(e)),"function"==typeof n&&n.call()}),F.allowtext&&E.text&&!k&&E.text.ensurePageTextLoaded(e)}else"function"==typeof n&&n.call();return x.loadedImgs[o.cacheIndex]}}function Ze(e){var t=Xe(e);if(t){var n=x.scroller[0].scrollLeft,o=x.scroller[0].scrollTop;return ge(t[0],x.scroller[0],n,o,n+x.scroller[0].clientWidth,o+x.scroller[0].clientHeight)}return!1}function Xe(e){for(var t=null,n=0;n<x.pageDivs.length&&null===t;n++)x.pageDivs[n]._index===e&&(t=x.pageDivs[n]);return t}function Ge(e,t,n,o,i){o&&"function"==typeof o&&(i=o,o=!1);var a,r=Xe(e);if(r){var l=x.scroller[0].scrollLeft,s=x.scroller[0].scrollTop;if((a=ie(r[0],x.scroller[0])).left+=t.x,a.top+=t.y,!o&&a.left>=l&&a.left<=l+l+x.scroller[0].clientWidth&&a.top>=s&&a.top<=s+x.scroller[0].clientHeight)return void(i&&i())}else(a=le(e)).left=a.width+t.x,a.top=a.height+t.y;var c={x:x.scroller[0].clientWidth/2,y:x.scroller[0].clientHeight/2};Ye(n,nn.BottomLeft)?(c.x=x.scroller[0].clientWidth,c.y=x.scroller[0].clientHeight):Ye(n,nn.TopLeft)&&(c.x=0,c.y=0),xe(a.left-c.x,a.top-c.y,!0,i)}function Ye(e,t){return e&&t&&e.x===t.x&&e.y===t.y}var Qe=null;function Je(){Qe&&clearTimeout(Qe),Qe=setTimeout(function(){Yt("documentchanged")},200)}function Ke(){x.scroller.stop(),x.scroller.pauseEventPropagation(),je()}function $e(){we(),0<x.pageDivs.length&&Ze(E.document.getPageCount()-1)&&Ce(x.pageDivs[0]._index),ke(),x.scroller.resumeEventPropagation(),Ne()}function et(){M.zooming=!0,Ke(),Yt("zoomstarted")}function tt(e){var t,n,o,i,a,r,l;e=Math.min(e,$()),e=Math.max(e,K()),t=e,n=!1,i=le(S.number,null,null),a=le(S.number,null,null,t),r=(x.scroller.scrollLeft()-i.width)/F.zoom*t,l=(x.scroller.scrollTop()-i.height)/F.zoom*t,xe(a.width+r,a.height+l,n,C,o),F.zoom=e,ct(!1),lt(e,!1)}function nt(){M.zooming=!1,$e(),Yt({type:"zoomchanged",zoom:F.zoom})}
/**
   * Asynchronously zooms the viewer to the given zoom over the default zoom duration
   * @param {number} zoom - Desired zoom level to zoom to.
   * @param {NotificationCallback} [callback] - function to execute after the zoom is finished animating.
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function zoom
   */function ot(e,n){var o=this;if(M.zooming)pe("zooming",n);else if(M.zooming=!0,Ke(),Yt("zoomstarted"),e!==F.zoom){e=Math.min(e,$()),e=Math.max(e,K());var t=le(S.number,null,null),i=le(S.number,null,null,e),a=(x.scroller.scrollLeft()-t.width)/F.zoom*e,r=(x.scroller.scrollTop()-t.height)/F.zoom*e;F.zoom=e,ct(!0,function(){var t=this;Dn(this,o),lt(e,!0,function(){var e=this;Dn(this,t),it(),xe(i.width+a,i.height+r,!1,C,function(){Dn(this,e),x.scrollH&&x.scrollH.scrollLeft(x.scroller.scrollLeft()),x.scrollV&&x.scrollV.scrollTop(x.scroller.scrollTop()),null!=n&&n()}.bind(this))}.bind(this))}.bind(this))}else it(),"function"==typeof n&&n.call()}function it(){M.zooming=!1,$e(),Yt({type:"zoomchanged",zoom:F.zoom})}function at(e,t){ot(F.zoom+(e?-1:1)*F.zoom*.3,t)}function rt(){x.edges[0]._z=F.zoom}function lt(e,t,n){if(0<x.edges.length){n="function"==typeof n?un([rt,n]):rt;var o=F.direction===en.Vertical,i=le(x.pageDivs[0]&&x.pageDivs[0]._img?x.pageDivs[0]._index:0,null,null,e),a=o?i.height:i.width;if(t&&!M.loading){var r=o?{height:a}:{width:a};x.edges[0].animate(r,{duration:C,easing:"easeOutQuad",complete:n,queue:!1})}else o?x.edges[0].height(a):x.edges[0].width(a),"function"==typeof n&&n.call();st()}}function st(u){setTimeout(function(){var e=Qt("<canvas/>");u=u||F.zoom;var t=F.direction===en.Vertical,n=M.newpagedivsize?M.newpagedivsize:{width:S.size.width*u,height:S.size.height*u},o=Math.max(1,F.pagespacing),i=ue();e[0].width=(n.width+o)*(t?i:1),e[0].height=n.height*(t?1:i);var a=e[0].getContext("2d");a.lineWidth=F.pageborderwidth,F.backcolor&&(a.fillStyle=F.backcolor);for(var r=0;r<i;++r){var l=t?1+r*n.width:1,s=t?1:1+r*n.height;a.strokeRect(l,s,n.width-2,n.height-2),F.backcolor&&a.fillRect(l+a.lineWidth,s+a.lineWidth,n.width-2*(1+a.lineWidth),n.height-2*(1+a.lineWidth))}var c={backgroundImage:"url("+e[0].toDataURL()+")",backgroundSize:"auto auto",backgroundRepeat:t?"repeat-y":"repeat-x"};x.edges[0].css(c),x.edges[1].css(c)},0)}function ct(e,t){for(var n=0,o=!0,i=function(){if(--n<=0){if(F.direction===en.Horizontal){var e=re().width;x.spacer||(x.spacer=I(),x.spacer.css({position:"absolute",top:"-1px",height:"1px"}),x.viewport.append(x.spacer)),x.spacer.width(e)}"function"==typeof t&&t.call(),0===M.prpr&&(Kt.Safari||Kt.Chrome)&&x.edges[1].hide().show()}},a=0;a<x.pageDivs.length;a++){if(x.pageDivs[a]._img)(x.pageDivs[a]._img.needsZoom()||x.pageDivs[a]._img.needsRotate())&&(o=!1,n++,x.pageDivs[a]._img.needsRotate()?x.pageDivs[a]._img.rotate(i):x.pageDivs[a]._img.needsZoom()&&x.pageDivs[a]._img.zoom(e,i))}o&&i.call()}
/**
   * Asynchronously zooms the viewer to fit to a page.
   * @param {Atalasoft.Utils.Fitting} fit - Type of fitting to fit the page to.
   * @param {number} pageNumber - Page number to fit to.  Note, that it's 1-based.
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function fit
   */function ut(e,t,n){null!=t?"function"==typeof t&&(n=t,t=S.number):t=S.number;var o=dt(e,t-1),i=o.zoom,a=tn.Width===o.fit&&en.Vertical===F.direction,r=tn.Height===o.height;a&&xe(0,null,!1),r&&xe(null,0,!1),ot(i,n)}function dt(e,t){var n,o,i,a=(n=fe(),o=F.showpageborder?2*F.pageborderwidth:0,i={width:n.width-o,height:n.height-o},F.tabular&&(1<F.columns&&(i.width=Math.floor((n.width-(F.pagespacing+o)*F.columns)/F.columns)),1<F.rows&&(i.height=Math.floor((n.height-(F.pagespacing+o)*F.rows)/F.rows))),i),r=te(t,1,!1);0!==r.width&&0!==r.height||(e=null);var l=F.zoom;switch(e){case tn.None:break;case tn.Best:e=r.width/a.width>r.height/a.height?(l=a.width/r.width,tn.Width):(l=a.height/r.height,tn.Height);break;case tn.Height:l=a.height/r.height;break;case tn.Width:l=a.width/r.width;break;default:l=1,e=tn.None}return{zoom:l,fit:e}}function ht(e){return F.zoom*E.document.getPageFitMultiplier(e)}function ft(e){return E.document.getPageRotation(e)}function pt(e,t){t=t||0;var n=ft(e),o=ht(e),i=de(e,t),a=Jt.matrix();a.scale(o,o,0,0),a.rotate(n+t,0,0);var r,l,s=(r=a,l={x:i.width,y:i.height},{x:r.x(l.x,l.y),y:r.y(l.x,l.y)}),c=Math.min(0,s.x),u=Math.min(0,s.y),d=a.invert(),h=d.x(-c,-u),f=d.y(-c,-u);return a.translate(h,f),a}function gt(e){var t=Qt.data(e.currentTarget,"_config"),n=Qt.data(e.currentTarget,"_annoConfig");!n&&t&&(n={type:t.icon,rotatable:F.showrotatetools}),n&&(E.mouseTool.setTool($t.None,$t.None),E.annotations.drawAnnotation(n,!1,vt,mt))}function mt(){E.mouseTool.setTool($t.Pan,$t.None)}function vt(){E.mouseTool.setTool($t.Pan,$t.None)}
/**
   * Checks whether annotations support is enabled.
   * @private
   */function bt(){return!1===F.allowannotations&&A("InitError",'The "allowannotations" property in the WebDocumentViewer config is set to false.'),F.allowannotations}function yt(){for(var e=0;e<x.pageDivs.length;e++)x.pageDivs[e]._draw.toFront()}function xt(){for(var e=0;e<x.pageDivs.length;e++)x.pageDivs[e]._draw.reset()}function _t(e,t,n){if(e){if(M.loading=!0,Ve(),S.size.width=e.pagewidth,S.size.height=e.pageheight,S.count=e.pagecount,S.buffer=F.pagebuffersize,S.dpi=e.dpi,S.vector=!0===e.vector,F.allowannotations=n.allowannotations,F.allowforms=n.allowforms,F.allowtext=n.allowtext,F.documenturl=n.documenturl,F.annotationsurl=n.annotationsurl,F.formsurl=n.formsurl,E.document.__linkChanges(t),E.annotations&&(E.annotations.clear(),E.annotations.loadAnnotations(e)),E.forms&&(E.forms.clear(),e.forms&&E.forms.loadForms(e)),E.text&&E.text.search(""),M.scrollTargetPage=0,M.zooming=!1,e.zoom)F.zoom=e.zoom;else{var o=dt(F.fitting,1);F.zoom=o.zoom}Tt(e.pagenumber||0),E.mouseTool.setTool(F.mousetool.type&&!k?F.mousetool.type:$t.Pan,$t.None),st(),M.loading=!1,ct(),q=t.__getSelectedPagesIndices,Yt({type:"activedocumentchanged"})}}function wt(e,t){t&&Lt(!0);for(var n=0;n<e._controllers.document.getPageCount();++n){var o=e._controllers.document.getPageDefinition(n,s);o&&0<=o.cacheIndex&&x.loadedImgs[o.cacheIndex]&&(E.memory.deallocate(x.loadedImgs[o.cacheIndex]),x.loadedImgs[o.cacheIndex].dispose(),x.loadedImgs[o.cacheIndex].remove(),x.loadedImgs[o.cacheIndex]=void 0)}}function zt(e,o){M.loading=!0;var t={atala_docurl:F.documenturl,atala_pagebuffer:F.pagebuffersize,atala_minwidth:F.minwidth};k&&(t.atala_thumb=k,t.atala_capt_format=F.thumbcaptionformat),null!=e&&("function"==typeof e&&(o=e,e=null),Qt.extend(t,e)),Vt({type:"docinfo",serverurl:F.serverurl,query:"?ataladocinfo=",method:"GET",data:t,cancel:!1,info:{pagewidth:-1,pageheight:-1,pagecount:-1}},function(e){Pt(e,o)},function(e,t,n){!function(e,t,n,o){if(e.responseText){var i=e.responseText.substr(e.responseText.indexOf("</html>")+7);0<=i.indexOf("\x3c!--")?0<(i=i.replace("\x3c!--","").replace("--\x3e","")).length&&(n="<pre>"+i+"</pre>"):0<e.responseText.indexOf("web.config")&&0<e.responseText.indexOf("customErrors")&&(n+=": web.config customErrors attribute has disabled remote error messages.")}A("DocumentLoadError",n),"function"==typeof o&&o.call(void 0,n)}(e,0,n,o)})}function Pt(t,n){var e,o;t&&!1!==t.licensed?(S.size.width=t.pagewidth,S.size.height=t.pageheight,S.count=t.pagecount,S.buffer=F.pagebuffersize,S.dpi=t.dpi,S.vector=!0===t.vector,S.caption=t.thumbcaptionformat||(F.showthumbcaption?"{0}":""),ae.zero(),E.memory.clearEntries(),E.memory.colorDepth=t.colordepth,E.memory.pageSize={width:t.pagewidth,height:t.pageheight},Yt({type:"documentinfochanged",info:{count:S.count,dpi:S.dpi,size:{height:S.size.height,width:S.size.width},vector:S.vector},customData:t.customData}),E.text&&(E.text.clear(),t.text&&E.text.loadText(t)),M.loading&&(F.zoom=1,W(),xe(0,0),x.scrollV&&x.scrollV.pageNum(1),Oe(1),ut(F.fitting,1,function(){ke(),Ce(0,x.pageDivs.length-1);for(var e=0;e<x.pageDivs.length&&e<S.count;e++)x.content.append(x.pageDivs[e]),Be(x.pageDivs[e],null,e);0<x.pageDivs.length&&x.pageDivs[0].addClass(an.atala_active_page),t.layers&&t.layers.length?E.annotations.loadAnnotations(t):F.annotationsurl&&E.annotations&&E.annotations.clear(),E.forms&&(E.forms.clear(),t.forms&&E.forms.loadForms(t)),E.mouseTool.setTool(F.mousetool.type&&!k?F.mousetool.type:$t.Pan,$t.None),M.loading=!1,st(),"function"==typeof n&&n(t.error,t),t.error&&setTimeout(function(){A("DocumentLoadError",t.error)},0)})),M.loading=!1):(o=t&&!1===t.licensed?(e="LicenseException",t.error?t.error:"LicenseException: Handler was unable to find a valid license."):(e="DocumentLoadError","HandlerException: Handler did not return any data."),M.loading=!1,"function"==typeof n&&n.call(void 0,o),e&&o&&A(e,o))}function Dt(){Tt()}function Tt(e){if(W(),0<x.pageDivs.length){var t=E.document.getPageCount(),n="number"==typeof e?e:x.pageDivs[0]._index;n=0<=n?Math.min(n,t-x.pageDivs.length):0;for(var o=0;o<x.pageDivs.length&&o<t;o++){var i=n+o;He(x.pageDivs[o]),x.content.append(x.pageDivs[o]),Be(x.pageDivs[o],null,i)}}Ce(0<x.pageDivs.length?x.pageDivs[0]._index:0,null),ke(),Mt(),we();var a=oe(x.scroller[0].scrollLeft,x.scroller[0].scrollTop);Oe(a+1),0<=e&&a!==e&&Fe(e)}function kt(e,t){var n={atala_docurl:F.documenturl,atala_spath:F.savepath};function o(e){!function(e){e.error?A("DocumentSaveError",e.error):ve("DocumentSave: success="+e.success);Yt({type:"documentsaved",success:e.success,customData:e.customData,fileName:e.fileName})}(e),"function"==typeof t&&t.call()}Qt.extend(n,e),Vt({type:"docsave",serverurl:F.serverurl,query:"?ataladocsave=",method:"POST",data:n,cancel:!1,info:{success:void 0,error:void 0}},o,function(e){var t=[];t.error=e.responseText,o(t)})}function Ct(e,t,n){var o=null;return"string"==typeof e?(o={},M.initialized&&n&&(0<e.length?o=n.createHandlerRequest(F.serverurl,e,t):0===e.length&&n.clear()),o.url=e):void 0!==e&&null!=e&&A("openUrlError","string input expected for url."),o}function Et(){Xt({annotationsloaded:It})}function St(){Xt({formsloaded:Ot})}function Mt(e){if(!(0<x.pageDivs.length&&void 0===x.pageDivs[0]._index))for(var t=0;t<x.pageDivs.length;t++)At(x.pageDivs[t],e)}function Ft(e,t){var n=Xe(e);n&&At(n,t)}function At(e,t){(Be(e,We(e._index),e._index)||t)&&(E.annotations&&E.annotations.showLayer(e._index,e),E.forms&&!k&&E.forms.showLayer(e._index,e),E.text&&!k&&F.allowtext&&E.text.showLayer(e._index,e))}function It(e){e.error&&(A("AnnotationsLoadError",e.error),F.annotationsurl=""),E.annotations&&Gt({annotationsloaded:It})}function Ot(e){e.error&&(A("FormsLoadError",e.error),F.formsurl=""),E.forms&&Gt({formsloaded:Ot})}function Vt(o,t,i,n){var a,r,e,l=this,s=(a=o,r=function(e){t(e.request.info)},Xt({handlerreturned:e=function e(t){t.request===a&&(Gt({handlerreturned:e}),"function"==typeof r&&r.call(this,t))}}),e);if(Yt({type:"beforehandlerrequest",request:o}),!o.cancel&&(Gt({handlerreturned:s}),o.serverurl&&!Qt.isEmptyObject(o.data))){if(!(o.info instanceof Qt&&"docpage"===o.type)){if("fileupload"!==o.type)return Qt.ajax({type:o.method,url:o.serverurl+o.query+"?",dataType:"json",data:o.data,success:t,error:i,crossDomain:("string"!=typeof o.method||"post"!==o.method.toLowerCase())&&void 0});var c="&"+Qt.param(o.data),u=new FormData;u.append("file",o.file,o.file.name);var d=Qt.ajax({type:o.method,url:o.serverurl+o.query+"??"+c,dataType:"json",data:u,contentType:!1,processData:!1,success:function(e){Dn(this,l),e.success&&(e.success=JSON.parse(e.success)),e.canceled&&(e.canceled=JSON.parse(e.canceled)),t(e,o.file.name)}.bind(this),error:function(e,t,n){Dn(this,l),i(t,n,o.file.name)}.bind(this),crossDomain:("string"!=typeof o.method||"post"!==o.method.toLowerCase())&&void 0,xhr:function(){var t=this;Dn(this,l);var e=new XMLHttpRequest;return e.upload.addEventListener("progress",function(e){Dn(this,t),e.lengthComputable&&(n(o.file.name,e.loaded,e.total)||d.abort())}.bind(this),!1),e}.bind(this)});return d}o.info.attr("src",o.serverurl+o.query+"&"+Qt.param(o.data))}}
/**
   * Resets the viewer to its default state.
   * @param {OpenUrlCallback} [callback]  - Function to execute when the empty process is finished
   * @instance
   ...
   * @function empty
   */
function Ht(e){M.loading=!0;Lt(),Pt({pagewidth:0,pageheight:0,pagecount:-1},function(){we(),Yt({type:"documentunloaded"}),"function"==typeof e&&e.call()})}function Lt(e){var t;M.initialized&&(Ve(),W(0),e||function(){for(var e=0;e<x.loadedImgs.length;e++)x.loadedImgs[e]&&(x.loadedImgs[e].dispose(),x.loadedImgs[e].remove());x.loadedImgs.length=0}(),x.edges[0].width(0).height(0),x.edges[1].width(0).height(0),x.scrollH&&(x.scrollH.scrollSize(0),Pe(x.scrollH)),x.scrollV&&(x.scrollV.scrollSize(0),Pe(x.scrollV)),t={backgroundImage:"",backgroundSize:"",backgroundRepeat:"",backgroundColor:""},x.edges[0].css(t),x.edges[1].css(t))}
/**
   * Gets the current zoom level of the viewer.
   * @returns {number}
   * @instance
...
/**
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function openUrl
   */function Ut(e,t,n,o){null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null));var i=0,a=!1,r=Ct(t,e,E.annotations),l=Ct(n||e,e,E.forms);F.annotationsurl=r?r.url:F.annotationsurl,F.formsurl=l?l.url:F.formsurl;var s,c,u,d,h=function(e,t){--i<=0&&(Mt(!0),Yt({type:"documentloaded",customData:null==t?void 0:t.customData}),"function"==typeof o&&o.call(void 0,e,t))};if("string"==typeof e){if(0===e.length)Ht(h);else if(F.documenturl=e,M.initialized){Lt(),G(x.scrollH),G(x.scrollV),i++;var f={};F.allowannotations&&r&&r.data&&(Et(),Qt.extend(f,r.data)),F.allowforms&&l&&l.data&&(St(),Qt.extend(f,l.data)),a=!0,zt(f,h)}}else!(e||!(0<F.documenturl.length)||!t&&""!==t&&!n&&""!==n)||A("openUrlError","string input expected for document url.");a||(r&&(i++,u=r,d=h,E.annotations&&(Et(),E.annotations.makeHandlerRequest(u,d))),l&&(i++,s=l,c=h,E.forms&&(St(),E.forms.makeHandlerRequest(s,c))))}
/**
   * Saves the client changes in this document to the predefined save folder or to the given path.
   * @param {string} [subpath] - Relative path to save to starting from {@link WebDocumentViewerConfig.savepath | savepath}. Must be writable.
   * @param {string} [saveformat] - Save file format. If specified, the value overrides {@link WebDocumentViewerConfig.savefileformat | savefileformat} form config.
...
/**
   ...
   * @function dispose
   */
function(){if(!k&&r&&r.closeDocument(),Lt(),x.main&&x.main.remove(),x.toolbar&&(x.toolbar.controlgroup("destroy"),x.toolbar.remove(),x.toolbar.annoToolbar&&(x.toolbar.annoToolbar.controlgroup("destroy"),x.toolbar.annoToolbar.remove())),x.search&&x.search.dispose(),x.uploadCtrl&&x.uploadCtrl.remove(),x.main=null,x.toolbar=null,x.scroller=null,x.viewport=null,x.content=null,x.scrollH=null,x.scrollV=null,x.loadedImgs.length=0,x.pageDivs.length=0,x.pageLabel=null,x.status=null,x.search=null,x.uploadCtrl=null,x.edges){for(var e=0;e<x.edges.length;e++)x.edges[e]=null;x.edges=[]}for(var t in E)E.hasOwnProperty(t)&&null!==E[t]&&(E[t].dispose(),E[t]=null);M={prpr:0,batchoperation:0,loading:(S={size:{width:0,height:0},sizes:[{width:0,height:0}],smallest:{width:0,height:0},count:0,number:-1,numberoutof:-1,buffer:3,dpi:96,vector:!1,caption:"",customData:null},!1),zooming:!1,initialized:!1,newpagedivsize:null,newpagedivfullzoom:1,scrollPos:{x:0,y:0,t:0},scrollBuffer:null,scrollTimeout:null,activepage:null,nextImageCacheIndex:0,scrollTargetPage:0,hidden:!1}},c.empty=Ht,c.fit=ut,c.getZoom=function(){return F.zoom},c.isReady=Bt,c.scrollTo=function(e,t,n,o){null==o&&"function"==typeof n&&(o=n,n=!1);xe(e,t,n,null,o)}
/**
   * Scrolls by the given deltas, does not account for zoom, i.e. `dx` and `dy` values are passed in window coordinate space.
   * @param {number} dx - Indicating delta of the x axis.
   * @param {number} dy - Indicating delta of the y axis .
   ...
   * @memberOf Atalasoft.Controls.WebDocumentViewer
   * @function scrollBy
   */,c.scrollBy=function(e,t,n,o){null==o&&"function"==typeof n&&(o=n,n=!1);i=e,a=t,r=n,l=null,s=o,xe(x.scroller.scrollLeft()+i,x.scroller.scrollTop()+a,r,l,s);var i,a,r,l,s},c.next=Rt,c.previous=jt,c.zoom=ot,c.zoomIn=Nt,c.zoomOut=qt,c.openUrl=c.OpenUrl=Ut,c.save=Wt,c.uploadFiles=
/**
   * Uploads several files on server to the predefined upload folder or to the given path.
   * @param {Array<File>} files - Array of file objects that should be uploaded.
   * @param {string} [uploadpath] - Relative path to upload to starting from {@link WebDocumentViewerConfig.upload.uploadpath | uploadpath}. Must be writable.
...
/**
   ...
   * @memberof Atalasoft.Controls.WebDocumentViewer
   * @function filterFilesForUpload
   */,c.filterFilesForUpload=function(e,t,n){if(k)return;return E.upload.filterFilesPublic(e,t,n)},c.getCurrentPageIndex=Zt,c.bind=Xt,c.unbind=Gt,c.trigger=Yt,c.getDocumentInfo=function(){return{count:E.document.getPageCount(),dpi:S.dpi,size:{height:S.size.height,width:S.size.width},vector:S.vector}},c.setMouseTool=function(e){for(var t in $t)if($t.hasOwnProperty(t)&&$t[t]===e){E.mouseTool.setTool(e);break}},c.isPageLoaded=function(e){var t=E.document.getPageDefinition(e);return 0<=t.cacheIndex&&x.loadedImgs[t.cacheIndex]&&x.loadedImgs[t.cacheIndex]._loaded}
/**
   * Reloads the specified page.
   * @param {number} index - The index of the page to reload.
   * @param {string|boolean} [annotations=false] - Url of the annotation xmp file or flag indicating whether to reload annotations of boolean flag indicating whether to load annotations data.
   ...
   * This object will be available on the server side handler as an key-values collection. This allows to pass specific load options for individual pages.
   * @function Atalasoft.Controls.WebDocumentViewer#reloadPage
   */,c.reloadPage=function(o,e,t,n,i){var a=Qt.Deferred(),r=Qt.Deferred(),l=Qt.Deferred(),s=Qt.Deferred();"function"==typeof n&&(i=n,n=void 0),"function"==typeof t&&(i=t,t=!1),"function"==typeof e&&(i=e,e=!1),"function"==typeof i&&a.done(i);var c=E.document.getPageDefinition(o);if(!c)return a.resolve(),a.promise();0<=c.cacheIndex&&x.loadedImgs[c.cacheIndex]?s=Ue(c,n):We(o,n,function(){s.resolve()});var u="string"==typeof e?e:c.uri?null:F.annotationsurl;F.allowannotations&&e&&(u||c.uri)?E.annotations.loadAnnotationsUrl(F.serverurl,u,c.uri,c.index,1,o,function(){r.resolve(!0)}):(e&&E.annotations.loadAnnotations({layers:[[]],offset:o}),r.resolve(!!e));var d="string"==typeof t?t:c.uri?null:F.formsurl;return F.allowforms&&t&&(F.formsurl||d)?E.forms.loadFormUrl(F.serverurl,d,c.uri,c.index,1,o,function(){l.resolve(!0)}):l.resolve(),Qt.when(s,r,l).done(function(e,t,n){(t||n)&&Ft(o,!0),a.resolve(o)}),a.promise()},c.showPage=Fe,c.showPageNumber=Ae,bn(),_n(),yn(),wn(),c.annotations=bn.__exposedApi,c.document=_n.__exposedApi,c.forms=yn.__exposedApi,c.text=wn.__exposedApi,function(){Bt()||(M={prpr:0,batchoperation:0,loading:(S={size:{width:0,height:0},sizes:[{width:0,height:0}],smallest:{width:0,height:0},count:0,number:-1,numberoutof:-1,buffer:3,dpi:96,vector:!1,caption:"",customData:null},!1),zooming:!1,initialized:!1,newpagedivsize:null,newpagedivfullzoom:1,scrollPos:{x:0,y:0,t:0},scrollBuffer:null,scrollTimeout:null,activepage:null,nextImageCacheIndex:0,scrollTargetPage:0,hidden:!1});var e={_config:F,_id:s,_dom:x,_document:x.loadedImgs,_pages:x.pageDivs,_state:M,_internalEvents:a,_controllers:E,createDOM:w,createDiv:I,createDialog:T,createDropDownButton:O,createDropDownMenu:V,createMenu:D,drawAnnotation:gt,redrawVisiblePages:Mt,adjustVisiblePages:ct,startDomManipulation:Ke,endDomManipulation:$e,redrawPageFromIndex:Ft,makeHandlerRequest:Vt,getPageScale:ht,getPageSize:he,getSourcePageSize:de,getPageRotation:ft,getViewerTransform:pt,isPageInView:Ze,findPageFromIndex:Xe,showPagePoint:Ge};E.document=new _n(c,e,s),c.document=E.document.__exposedApi,F.allowannotations?(E.annotations=new bn(c,e,k),c.annotations=E.annotations.__exposedApi):(c.deselectAll=bt,c.createAnnotationOnPage=bt,c.getAnnotationsFromPage=bt,c.deleteAnnotationOnPageAtIndex=bt,c.setAnnotationDefaults=bt,c.setImages=bt,c.setStamps=bt),F.allowforms&&!E.forms&&(E.forms=new yn(c,e),c.forms=E.forms.__exposedApi),F.allowtext&&(E.text=new wn(c,e,F.mousetool?F.mousetool.text:{}),c.text=E.text.__exposedApi),E.upload=new xn(c,e),!1===M.initialized&&(M.initialized=!0,Xt({throwerror:_,pagedivsresized:f,documentchanged:Dt,pagesizechanged:p}),F.parent?(F.parent instanceof Qt||(F.parent=Qt(F.parent)),F.parent.length||A("InitError","Parent element not found.")):A("InitError","No parent element given."),x.toolbar=(t=F.toolbarparent||F.parent,(n=function(e){var t=this,n={id:s+"_toolbar",parent:e,children:[{type:"button",id:"Button_PagePrev",cls:an.atala_tool_button_page_prev,icon:"page-prev",tooltip:"Previous Page",text:null,onclick:function(){jt()}},{type:"pagelabel",id:"Label_PageNumber",cls:an.atala_page_label},{type:"button",id:"Button_PageNext",cls:an.atala_tool_button_page_next,icon:"page-next",tooltip:"Next Page",text:null,onclick:function(){Rt()}},{type:"button",id:"Button_ZoomOut",cls:an.atala_tool_button_zoom_out,icon:"zoom-out",tooltip:"Zoom Out",text:"",onclick:function(){qt()}},{type:"button",id:"Button_ZoomIn",cls:an.atala_tool_button_zoom_in,icon:"zoom-in",tooltip:"Zoom In",text:"",onclick:function(){Nt()}},{type:"button",id:"Button_FitNone",cls:an.atala_tool_button_fit_none,icon:"zoom-full",tooltip:"Full Size",text:"",onclick:function(){ot(1)}},{type:"button",id:"Button_FitBest",cls:an.atala_tool_button_fit_best,icon:"fit-best",tooltip:"Best Fit",text:"",onclick:function(){ut(tn.Best)}},{type:"button",id:"Button_FitWidth",cls:an.atala_tool_button_fit_width,icon:"fit-width",tooltip:"Fit To Width",text:"",onclick:function(){ut(tn.Width)}}]};return F.showselecttools&&n.children.splice(5,0,{type:"button",id:"Button_ZoomArea",cls:an.atala_tool_button_zoom_area,icon:"zoom-area",tooltip:"Zoom Area",text:"",onclick:j}),F.allowtext&&(n.children.splice(3,0,{type:"button",id:"Button_Text",cls:an.atala_tool_button_text_tool,icon:"text-tool",tooltip:"Text Selection",text:"",onclick:function(){E.mouseTool.setTool($t.Text)}}),n.children.splice(3,0,{type:"button",id:"Button_Text",cls:an.atala_tool_button_pan_tool,icon:"pan-tool",tooltip:"Pan",text:"",onclick:function(){E.mouseTool.setTool($t.Pan)}})),F.showrotatetools&&(n.children.push({type:"button",id:"Button_RotateLeft",cls:an.atala_tool_button_rotate_left,icon:"rotate-left",tooltip:"Rotate Left",text:"",onclick:N(270)}),n.children.push({type:"button",id:"Button_RotateRight",cls:an.atala_tool_button_rotate_right,icon:"rotate-right",tooltip:"Rotate Right",text:"",onclick:N(90)})),0<F.savepath.length&&n.children.unshift({type:"button",id:"Button_Save",cls:an.atala_tool_button_save,icon:"save",tooltip:"Save Changes",text:null,onclick:function(){Wt()}}),!1!==F.upload.enabled&&n.children.unshift({type:"button",id:"Button_Upload",cls:an.atala_tool_button_upload,icon:"upload",tooltip:"Upload document",text:null,onclick:function(){!function(){var t=this;k||E.upload.uploadWithUi(function(e){Dn(this,t),e?(x.toolbar.controlgroup("enable"),F.allowannotations&&x.toolbar.annoToolbar.controlgroup("enable"),x.toolbar.find(".atala_page_label, .atala_search_container").removeClass("ui-state-disabled")):(x.toolbar.controlgroup("disable"),x.toolbar.annoToolbar&&x.toolbar.annoToolbar.controlgroup("disable"),x.toolbar.find(".atala_page_label, .atala_search_container").addClass("ui-state-disabled"))}.bind(this))}()}}),F.toolbarbuttons&&F.toolbarbuttons.reverse().forEach(function(e){Dn(this,t),n.children.unshift({type:"button",id:e.id,cls:e.class,tooltip:e.tooltip,onclick:e.onclick,text:null,icon:e.icon,custom:!0})}.bind(this)),P(n)}(t)).controlgroup(),F.allowannotations&&(n.annoToolbar=P({id:s+"_toolbar",parent:t,children:[{type:"button",id:"Button_Ellipse",cls:an.atala_tool_button_ellipse_anno,icon:"ellipse",tooltip:"Draw Ellipse",text:"",onclick:gt},{type:"button",id:"Button_Highlight",cls:an.atala_tool_button_highlight_anno,icon:"highlight",tooltip:"Draw Highlight",text:"",onclick:gt},{type:"button",id:"Button_Line",cls:an.atala_tool_button_line_anno,icon:"line",tooltip:"Draw Line",text:"",onclick:gt},{type:"button",id:"Button_Lines",cls:an.atala_tool_button_lines_anno,icon:"lines",tooltip:"Draw Poly Lines",text:"",onclick:gt},{type:"button",id:"Button_Freehand",cls:an.atala_tool_button_freehand_anno,icon:"freehand",tooltip:"Draw Freehand",text:"",onclick:gt},{type:"button",id:"Button_Polygon",cls:an.atala_tool_button_polygon_anno,icon:"polygon",tooltip:"Draw Polygon",text:"",onclick:gt},{type:"button",id:"Button_Rectangle",cls:an.atala_tool_button_rect_anno,icon:"rectangle",tooltip:"Draw Rectangle",text:"",onclick:gt},{type:"button",id:"Button_Text",cls:an.atala_tool_button_text_anno,icon:"text",tooltip:"Draw Text",text:"",onclick:gt}]}),n.annoToolbar.addClass(an.atala_annotation_toolbar),n.annoToolbar.controlgroup()),F.showstatus&&(x.status=Qt('<div id="'+s+'_status" style="display:inline"></div>'),x.status.addClass(an.atala_statusbar),n.append("Status:"),n.append(x.status)),F.allowtext&&F.mousetool.text.allowsearch&&(x.search=new R({parent:n})),n),x.toolbar.addClass(an.atala_toolbar),x.main=I(F.parent),x.main.addClass(an.atala_main_container),x.scroller=I(x.main),x.scroller.addClass(an.atala_scroller),x.main.on({selectstart:v}),x.toolbar.attr("id",s+"_toolbar"),x.main.attr("id",s+"_main"),x.scroller.attr("id",s+"_scroller"),x.main.css({height:"100%",width:"100%",position:"relative"}),x.scroller.css({height:"100%",width:"100%",position:"relative"}),x.viewport=I(x.scroller,s+"_vp"),x.viewport.css({overflow:"hidden",fontSize:0,"touch-action":"none"}),x.viewport.addClass(an.atala_viewport),x.viewport.attr("tabindex",-1),x.edges[0]=U(x.viewport,s+"_e0"),x.edges[0].addClass(an.atala_dom_edge_first),x.content=I(x.viewport,s+"_ct"),x.content.addClass(an.atala_content),x.content.css({"-ms-touch-action":"none",fontSize:0,overflow:"hidden"}),F.direction===en.Horizontal&&x.content.css({display:"inline-block"}),x.edges[1]=U(x.viewport,s+"_e1"),x.edges[1].addClass(an.atala_dom_edge_last),Kt.Features.Compatibility&&A("InitError","Compatibility Mode is not supported."),!1===F.upload.enabled||k||(x.uploadCtrl=E.upload.getUploadControl()),Kt.Mobile.Any()?x.scroller.css({overflow:"hidden"}):F.showscrollbars?(x.scroller.css({overflow:"auto"}),x.scrollH=X(x.main,en.Horizontal),x.scrollH.attr("id",s+"_sH"),x.scrollH.addClass(an.atala_scroll_horizontal),x.scrollV=X(x.main,en.Vertical),x.scrollV.attr("id",s+"_sV"),x.scrollV.addClass(an.atala_scroll_vertical)):x.scroller.css({overflow:"hidden"}),E.mouseTool=new zn(c,{_internalEvents:a,_controllers:E,zoomStart:et,zoom:tt,zoomEnd:nt,getActivePage:Ee,raiseDrawLayer:yt,resetDrawLayer:xt,getViewerTransform:pt},x.viewport,x.scroller,Qt.extend({allowflick:F.allowflick},F.mousetool)),E.memory=new gn({highWaterMark:F.memorythreshold}),E.memory.bind({exceededhighwatermark:h}),E.annotations&&E.annotations.setViewPort(x.viewport),Yt("initialized"),F.direction===en.Horizontal&&x.viewport.css({"white-space":"nowrap"}),x.viewport.css({display:"table-cell"}),Y(x.scroller),x.scrollH&&x.edges[1].height(x.scrollH.scrollbarHeight()),E.mouseTool.setTool($t.Pan,$t.None),(F.documenturl||F.annotationsurl||F.formurl)&&Ut(F.documenturl,F.annotationsurl,F.formurl,o),Qt(m));var t,n}(),c};function Me(e,t){return e.singlepage?new Se(e,t):new Ke(e,t)}function $e(e,t){if(e!==t)throw new TypeError("Cannot instantiate an arrow function")}
/**
...
/**
     ...
     */
selecteditemsorder:Qe.ItemIndexOrder},t={type:"Atalasoft.Controls.WebDocumentThumbnailer",debug:!0,showpageborder:!0,forcepagefit:!0,toolbarparent:Qt("<div/>")},i={
/**
...
/** Triggers after thumbnail drag & drop operation is complete.
     ...
     * @param {ThumbDragCompleteEventArgs} args - The event data.
     */
thumbdragcomplete:null};function D(){return{get:function(){return h},detachViewer:E,activateViewer:C}}function T(e,t){if(e){var n=t?e.bind:e.unbind,o=t?h.unbind:h.bind;n.call(e,{beforehandlerrequest:De,documentloaded:fe,scroll:ye,pagerotated:ze,pageinserted:ge,pageremoved:ve,pagemoved:be}),o.call(h,{pagerotated:pe,pageinserted:pe,pageremoved:pe,pagemoved:pe}),a(e,e.document.events,n),P.allowannotations&&(n.call(e,{annotationresized:Pe,annotationmoved:Pe,annotationrotated:Pe,annotationchanged:Pe,annotationcreated:_e,annotationdeleted:we}),e.annotations&&a(e,e.annotations.events,n))}}function a(e,t,n){var o={};for(var i in t)t.hasOwnProperty(i)&&(o[i]=r);n.call(e,o)}function r(){h.trigger.apply(h,arguments)}
/**
   ...
   */function k(){return f&&(!x||x&&x.isThumbnailerActive(D()))}
/**
...
/**
   ...
   * @returns {number[]}
   */
function V(){var n=this,e=p.slice(0);return P.selecteditemsorder===Qe.ItemIndexOrder&&e.sort(function(e,t){return $e(this,n),e-t}.bind(this)),e}function H(e){var t=1,n=function(){--t<=0&&(k()&&x&&f&&C(f,h.getDocumentInfo(),!0),"function"==typeof e&&e.call())};k()&&(x?x.closeDocument(D(),u):f.isReady()&&(t++,f.empty(n))),L(n)}h.getSelectedPageIndex=
/**
   ...
   * @returns {number}
   */
function(){return V()[0]},h.getSelectedPagesIndices=V,h.selectThumb=U,h.deselectThumb=W,h.isActive=k,h.activate=function(){C(f,h.getDocumentInfo())};var L=function(){};function B(){k()&&(x?x.closeDocument(D(),u):f.empty(),E()),R(),m=f=null}var R=function(){};function j(e,t,n,o){w.base&&Qt.each(w.base.dom.pageDivs,function(e,t){t.off(c),t.thumbInitialized=!1}),null==o&&("function"==typeof t?(o=t,t=null):"function"==typeof n&&(o=n,n=null)),"string"==typeof e&&(x.closeDocument(D(),u),w.viewer.pagenumber=0,w.base&&(w.base.state.scrollPos.x=0,w.base.state.scrollPos.x=0)),N(e,t,n,function(e,t){h.scrollTo(0,0,!1),Se(e,t,o)})}var N=function(){};function q(e){if(w.base){0===p.length&&p.push(0);for(var t=0;t<w.base.dom.pageDivs.length;t++){var n=0<t?w.base.dom.pageDivs[t-1]:null,o=w.base.dom.pageDivs[t],i=!1;-1<p.indexOf(o._index)&&e?(o.removeClass("atala_grouped_selection"),o.addClass(h.domclasses.atala_active_thumb),null!==n&&-1<p.indexOf(n._index)&&(o.addClass("atala_grouped_selection"),n.addClass("atala_grouped_selection")),i=!0):(o.removeClass(h.domclasses.atala_active_thumb),o.removeClass("atala_grouped_selection")),J(o,i)}}}
/** 
   ...
   */function U(e,t,n){var o=this;if(m._controllers.upload&&m._controllers.upload.abort(),!(null===(e=Je(e))||e<0||e>=h.getDocumentInfo().count||void 0!==t&&"boolean"!=typeof t&&null!==t||void 0!==n&&"function"!=typeof n&&null!==n)){if(t=!!t&&P.selectionmode!==Ye.SingleSelect){if(-1<p.indexOf(e))return;p.push(e)}else V().forEach(function(e){$e(this,o),h.trigger({type:"thumbdeselected",index:e})}.bind(this)),p.length=0,p.push(e);Z(),h.trigger({type:"thumbselected",index:e}),"function"==typeof n&&n()}}
/** 
   ...
   */function W(e,t){if(null!==(e=Je(e))&&(void 0===t||"function"==typeof t||null===t)){var n=p.indexOf(e);-1!==n&&1!==p.length&&(p.splice(n,1),Z(),h.trigger({type:"thumbdeselected",index:e}),"function"==typeof t&&t())}}function Z(){var e=V();if(x?(w.viewer.pagenumber=e[0],C(f,h.getDocumentInfo())):q(!0),!(1<p.length)&&f){var t=f.getCurrentPageIndex(),n=e[0];0<=t&&n!==t&&(w.scrolling=!0,f.showPage(n,xe))}}
/**
