...
/**
       ...
       */
extra:{}},g={highlight:{fill:{color:"yellow",opacity:.5},outline:{opacity:0}},image:{fill:{color:null},outline:{opacity:0}},rectangle:{fill:{opacity:0}},stamp:{cornerradius:0,text:{autoscale:!0,verifyFontFamily:!1}},line:{fill:{color:null},outline:{opacity:1,startcap:{width:"medium",height:"medium",style:"none"},endcap:{width:"medium",height:"medium",style:"none"}}},lines:{fill:{color:null},outline:{opacity:1}},freehand:{fill:{color:null},outline:{opacity:1}},ellipse:{},fillrect:{},polygon:{},text:{text:{verifyFontFamily:!1}}},p={};function m(){o.bind.apply(o,arguments)}function v(){return o.trigger.apply(o,arguments),a}function b(){var e=gn.matrix(),t=C();e.rotate(f.rotation,t.x,t.y),f.transform=e}function y(){var e,t,n=C(),o=(e=w(),t=n,{x:e.x(t.x,t.y),y:e.y(t.x,t.y)});o.x===n.x&&o.y===n.y||E(o.x-n.x,o.y-n.y)}function x(e,t){if(e){var n=f.rotation;e.hasOwnProperty("rotation")&&(e.rotation=(e.rotation+360)%360),_(e,t),n!==f.rotation&&function(e,t){var n=(e-t+360)%360,o=gn.matrix(),i=w();o.add(i.a,i.b,i.c,i.d,i.e,i.f);var a=C();o.rotate(n,a.x+a.width/2,a.y+a.height/2);var r=o.x(a.x,a.y),l=o.y(a.x,a.y);E(r-a.x,l-a.y),b()}(f.rotation,n)}}function _(e,t){t?fn.extend(!0,f,e):fn.extend(f,e)}function w(){return f.transform}function z(){d={update:function(e){f.selected!==d.selected&&P();var t=!1,n=fn.extend(!0,{},f);delete n.update,delete n.getPageIndex,delete n.transform,s&&s.inEditMode()?v({type:"annotationtextchangefailed",anno:a}):(e||(t=function e(t,n,o){if(t!==n)return!!t;for(var i in t)if(t.hasOwnProperty(i)){if("extra"===i)continue;if(n.hasOwnProperty(i)){if("points"===i){if(t.points===n.points)return!t.points;if(t.points.length!==n.points.length)return!0;for(var a=0;a<t.points.length;a++)if(e(t.points[a],n.points[a],[]))return!0}if(-1<o.indexOf(i)){if(e(t[i],n[i],j[i]))return!0}else if(t[i]!==n[i])return!0}}return!1}(d,f,["fill","outline","text"]),x(d,!0)),f.update&&delete f.update,f.getPageIndex&&delete f.getPageIndex,V(),I(),null!==r&&(!f.readonly&&f.selectable?(p.isBound("selectable")||(o.bind(p.selectable),p.bound("selectable")),f.readonly||!f.movable||p.isBound("movable")?!f.readonly&&f.movable||!p.isBound("movable")||(o.unbind(p.movable),p.unbound("movable")):(o.bind(p.movable),p.bound("movable")),pn.Features.Touch&&(f.readonly||!f.resizable||p.isBound("resizable")?!f.readonly&&f.resizable||!p.isBound("resizable")||(o.unbind(p.resizable),p.unbound("resizable")):(o.bind(p.resizable),p.bound("resizable")))):!f.readonly&&f.selectable||!p.isBound("selectable")||(o.unbind(p.selectable),p.unbound("selectable"),o.unbind(p.movable),p.unbound("movable"),o.unbind(p.resizable),p.unbound("resizable"))),t&&v({type:"annotationchanged",ann:a,annobefore:n}))},getPageIndex:function(){return a._pageindex}},fn.extend(!0,d,f)}function k(){return JSON.stringify(f)}function P(e){if(f){var t={ann:a,append:!0,page:null,pageindex:a._pageindex,type:""};e&&(t.append=e.shiftKey||e.ctrlKey||void 0!==e.append&&e.append,t.page=e.page,t.pageindex=e.pageindex),t.append||!f.selected?(f.selected=!f.selected,t.type=f.selected?"selected":"deselected"):f.selected&&!t.append&&(t.type="reselected"),""!==t.type&&v(t)}}function T(e){var t=null;switch(f.type){case"image":(t=e.image()).attr("src",f.src);break;case"highlight":case"rectangle":case"fillrect":case"text":case"stamp":t=e.rect();break;case"ellipse":case"line":case"lines":case"freehand":case"polygon":t=e.path();break;case"custom":t=u.construct(e)}return e._annos&&e._annos.push(t),t}function D(){null!==r&&(l?o.unbind(l,r):o.unbind(r));var e={};!f.readonly&&f.selectable&&(fn.extend(e,p.selectable),p.bound("selectable"),i.readonly||f.readonly||!f.movable||(fn.extend(e,p.movable),p.bound("movable")),!i.readonly&&!f.readonly&&f.resizable&&pn.Features.Touch&&(fn.extend(e,p.resizable),p.bound("resizable"))),r=e,o.bind(l,e)}
/**
   * Returns bounding box of the annotation in document space.
   */
function C(){!h&&f.points&&(h=_e(f.points));var e=f.points?h:f;return{x:e.x,y:e.y,width:e.width,height:e.height}}function E(e,t){if(f.points){for(var n=0;n<f.points.length;n++)f.points[n].x+=e,f.points[n].y+=t;h&&(h.x+=e,h.y+=t)}"custom"!==f.type&&f.points||(f.x+=e,f.y+=t),b(),A()}e.multiview||(M=e.type,fn.extend(!0,f,g[M])),_(e,!0),b(),"custom"===f.type&&(u=new N(f,o)),m({repaint:(c=new q(f,i,o,a,u)).events.update,viewchanged:c.events.viewchanged,drawn:D,resized:y}),f.points&&(0<f.x||0<f.y)&&(E(f.x,f.y),f.x=0,f.y=0,f.width=1,f.height=1),p={selectable:{selectchange:P},movable:{dragstart:c.events.dragstart,dragmove:c.events.dragmove,dragend:c.events.dragend},resizable:{pinchstart:c.events.pinchstart,pinchmove:c.events.pinchmove,pinchend:c.events.pinchend},boundEvents:{resizable:!1,movable:!1,selectable:!1},isBound:function(e){return this.boundEvents[e]},bound:function(e){this.boundEvents[e]=!0},unbound:function(e){this.boundEvents[e]=!1}},a.dispose=function(){f.selected&&P(),o&&o.unbind(),l&&l.remove(),s&&s.dispose(),n&&n.remove(),c&&c.unbindEvents(),f=n=s=l=o=a=i=c=null},a.bind=m,a.unbind=function(){o.unbind.apply(o,arguments)},a.trigger=v,a.set=x,a.get=function(e){return e?f[e]:f},a.getTransform=w,a.notifyChanges=function(e){var t=fn.extend(!0,{},a.getClonedData());delete t.update,delete t.getPageIndex,fn.extend(!0,t,e),v({type:"annotationchanged",anno:a,annobefore:t})},a.getClonedData=function(){return d?fn.extend(!0,d,f):z(),delete d.transform,d},a.getObject=function(){return l},a.getEventObject=function(){return o},a.getZoom=function(){return i.getZoom(a._pageindex)},a.stringify=k,a.getJSON=k,a.toggleSelected=P,a.isCloneSource=function(e){return d&&d===e},a.getBox=C,a.translate=E,a.transform=function(e,t,n,o){var i=C(),a=n/i.width,r=o/i.height;if(f.points&&0<f.points.length&&"custom"!==f.type){for(var l=0;l<f.points.length;l++)f.points[l].x=e+(f.points[l].x-i.x)*a,f.points[l].y=t+(f.points[l].y-i.y)*r;h.x=e,h.y=t,h.width*=a,h.height*=r}else f.x=e,f.y=t,f.width*=a,f.height*=r;v({type:"annoresizing"}),A()},a.transformUI=function(){c.transformUI.apply(c,arguments)};var M;var S=(a.commitTransform=function(){c.commitTransform()},!1),F=pn.Explorer?20:5;function A(){S||(S=!0,setTimeout(O,F))}function O(){S=!1,I()}function I(e){e&&(n&&(n=null),l=T(e),u&&u.render(l,f),V(),D(),"text"!==f.type&&"stamp"!==f.type||null!==s||(s=new B(a,e,i)),s&&s.changepaper(e),v({type:"viewchanged",annview:l,textview:s})),v("repaint")}function V(){if(l){var e={fill:f.fill.color,"fill-opacity":f.fill.opacity};fn.extend(e,(t={stroke:f.outline.color,"stroke-width":f.outline.width*i.getZoom(a._pageindex),"stroke-opacity":f.outline.opacity},l._linewidth=f.outline.width,gn.fn.addArrow||(f.outline.startcap&&(t["arrow-start"]=H(f.outline.startcap)),f.outline.endcap&&(t["arrow-end"]=H(f.outline.endcap))),t)),l.attr(e),gn.fn.addArrow&&(f.outline.startcap&&gn.fn.addArrow(l,H(f.outline.startcap),!1),f.outline.endcap&&gn.fn.addArrow(l,H(f.outline.endcap),!0)),f.visible?l.show():l.hide()}var t;s&&(s.set(f.text),s.updateView()),l&&l.node&&""!==f.src&&"image"===f.type&&(void 0!==l.node.src&&l.node.src?l.node.src=f.src:l.node.href.baseVal=f.src),L()}function L(){f.tooltip&&"text"!==f.type&&"stamp"!==f.type&&l.attr("title",f.tooltip)}function H(e){return[e.style,"-",e.width,"-",e.height].join("")}a.startDraw=function(e,t,n,o){x(n),(l=T(t)).transform(c.getTransform()),("text"===f.type||"stamp"===f.type)&&(s=new B(a,t,i,o)),L(),V(),c.drawStart(e,l,s)},a.repaint=I,a.updateView=V;var j={fill:[],outline:["startcap","endcap"],text:["font"],font:[],startcap:[],endcap:[]};return a},ze=function(e,t){var n=this,o=e,i=t,c=[];function a(e,t,n,o){var i,a,r=[].concat(t),l=null;(l=u(n))===n&&null!==l&&(n=l._index),o||d(l||n);for(var s=0;s<r.length;s++)i=r[s],0<=(a=fn.inArray(i,c[n]))?e||c[n][a]!==i||c[n].splice(a,1):e&&(c[n]?c[n].push(i):c[n]=[i]),l&&(e?l._grips.push(i):null!==l._grips&&l._grips.remove(i)),i.get("selected")!==e&&i.toggleSelected({append:!0,pageindex:n,page:l})}function r(e,t){var n="object"==typeof t?t._index:t;o[n]&&a(e,o[n],t,!0)}function l(e){for(var t=[],n=0;n<e.length;n++)if(e[n]){t[n]=[];for(var o=0;o<e[n].length;o++)t[n][o]=e[n][o].getClonedData()}return t}function u(t){var e=null;if("object"==typeof t)e=t;else{t=Math.max(t,0);var n=fn.grep(i,function(e){return e._index===t});1<=n.length&&(e=n[0])}return e}function s(e){r(!0,e)}function d(e){r(!1,e);var t=u(e);t&&t._grips&&t._grips.repaint()}n.dispose=function(){i=o=n=null,c.length=0},n.select=function(e,t,n){a(!0,e,t,n)},n.deselect=function(e,t,n){a(!1,e,t,n)},n.setAnnos=function(e){o=e},n.setPages=function(e){i=e},n.resolvePage=u,n.deselectAll=function(){for(var e=0;e<o.length;e++)d(e)},n.deselectPage=d,n.getAnnotations=
/**
